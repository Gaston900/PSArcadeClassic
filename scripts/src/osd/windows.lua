...
project ("osd_" .. _OPTIONS["osd"])
	...
	files {
		...
		MAME_DIR .. "src/osd/scale/hq2x.cpp", -- 修改的 (EKMAME)
		MAME_DIR .. "src/osd/scale/hq3x.cpp", -- 修改的 (EKMAME)
		MAME_DIR .. "src/osd/scale/scale2x.cpp", -- 修改的 (EKMAME)
		MAME_DIR .. "src/osd/scale/scale3x.cpp", -- 修改的 (EKMAME)
		MAME_DIR .. "src/osd/scale/scanline.cpp", -- 修改的 (EKMAME)
