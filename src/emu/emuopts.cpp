...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_CFG_DIRECTORY,                              "config/cfg",       OPTION_STRING,     "directory to save configurations" },
	...
	{ OPTION_SHARE_DIRECTORY,                            "config/share",     OPTION_STRING,     "directory to share with emulated machines" },
	...
	{ OPTION_KEEPASPECT ";ka",                           "0",         OPTION_BOOLEAN,    "maintain aspect ratio when scaling to fill output screen/window" },
