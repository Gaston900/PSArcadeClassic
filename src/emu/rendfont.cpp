...
//	util::random_read::ptr ramfile = util::ram_read(font_uismall, sizeof(font_uismall));
	util::random_read::ptr ramfile = util::ram_read(font_uismall14, sizeof(font_uismall14));
//====================================================================>>>
...
void render_font::render_font_command_glyph()
{
	...
	std::error_condition const filerr = ramfile.open_ram(font_uicmd14, sizeof(font_uicmd14));
    if (!filerr)
...
#include "cmdplus.cpp"
    ...
    std::vector<char> d_vector(buflen);
    char *d = d_vector.data(); 
