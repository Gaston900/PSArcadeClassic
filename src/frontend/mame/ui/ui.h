...
private:
	...
	template <typename... Params> void slider_saved_alloc(Params &&...args) { m_sliders_saved.push_back(std::make_unique<slider_state>(std::forward<Params>(args)...)); } // 缘来是你 Slider save
	// slider controls
...
//=========================================================>>>
	...
	std::vector<std::unique_ptr<slider_state>> m_sliders_saved; //缘来是你 Slider save
};
