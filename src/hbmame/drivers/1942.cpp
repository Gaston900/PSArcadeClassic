...
ROM_START( 1942hack01 )
	...
	ROM_LOAD( "sr-01_hack01.c11", 0x0000, 0x4000, CRC(4ee7ab6b) SHA1(609d2d9124da47d305c15ee034efd64a73adc1c0) )
...
ROM_START( 1942hack02 )
	ROM_REGION( 0x20000, "maincpu", ROMREGION_ERASEFF )
	ROM_LOAD( "srb-03_hack02.m3", 0x00000, 0x4000, CRC(dcec86c9) SHA1(73ee4ca2d861eaa5805b4b8ff7db05cd6f06650a) )
	ROM_LOAD( "srb-04_hack02.m4", 0x04000, 0x4000, CRC(cdd75d78) SHA1(6ee714f9d3dd1a0c9404a8e3c8ca96a74c08e1cf) )
	ROM_LOAD( "srb-05.m5", 0x10000, 0x4000, CRC(d102911c) SHA1(35ba1d82bd901940f61d8619273463d02fc0a952) )
	ROM_LOAD( "srb-06.m6", 0x14000, 0x2000, CRC(466f8248) SHA1(2ccc8fc59962d3001fbc10e8d2f20a254a74f251) )
	ROM_LOAD( "srb-07.m7", 0x18000, 0x4000, CRC(0d31038c) SHA1(b588eaf6fddd66ecb2d9832dc197f286f1ccd846) )
...
ROM_START( 1942hack03 )
	ROM_REGION( 0x20000, "maincpu", ROMREGION_ERASEFF )
	ROM_LOAD( "srb-03_hack03.n3", 0x00000, 0x4000, CRC(c78cdc46) SHA1(50ac4ab7a884b8555f15d959dac2b33e317fcd16) )
	ROM_LOAD( "srb-04_hack03.n4", 0x04000, 0x4000, CRC(863f2f49) SHA1(dbe7d13bcaa3919e1be51ba04fbf50f898e5c76e) )
	ROM_LOAD( "srb-05_hack03.n5", 0x10000, 0x4000, CRC(0da115f9) SHA1(0517c60877a8067fb13c61c63a032a3f5ed16a57) )
	...
	ROM_REGION( 0x2000, "gfx1", 0 )
	ROM_LOAD( "sr-02_hack03.f2", 0x00000, 0x2000, CRC(b3e1862b) SHA1(736fbef1ef15892ba6ea87be5366abf520e3d5fd) )

	ROM_REGION( 0xc000, "gfx2", 0 )
	ROM_LOAD( "sr-08_hack03.a1", 0x00000, 0x2000, CRC(21f3fee2) SHA1(2eed32063b808fae27255e9b026fb92209cfc214) )
	ROM_LOAD( "sr-09_hack03.a2", 0x02000, 0x2000, CRC(5542beae) SHA1(f37fad84fbeb2f98092bdb2f2a3bc80804392e07) )
	ROM_LOAD( "sr-10_hack03.a3", 0x04000, 0x2000, CRC(118e87ec) SHA1(0b79eee01bd6aef2e85409de16ff9cb032c457cb) )
	ROM_LOAD( "sr-11_hack03.a4", 0x06000, 0x2000, CRC(fc3db895) SHA1(bc469fd6f5634eca77728a24e4e6d83a2074c780) )
	ROM_LOAD( "sr-12_hack03.a5", 0x08000, 0x2000, CRC(4a336de1) SHA1(8359abb42fc9f774350524a7fbf561e6c8799822) )
	ROM_LOAD( "sr-13_hack03.a6", 0x0a000, 0x2000, CRC(1d4a69c9) SHA1(34d3ea5e7666fee1ecd0ac763f3114d9c8d60806) )

	ROM_REGION( 0x10000, "gfx3", 0 )
	ROM_LOAD( "sr-14_hack03.l1", 0x00000, 0x4000, CRC(8408b932) SHA1(bea9d62156c566e7a3ae296e3e411d5542b7544b) )
	ROM_LOAD( "sr-15_hack03.l2", 0x04000, 0x4000, CRC(2218cb80) SHA1(5dd05b59a55804bedf637abb339188e9c9e6037a) )
	ROM_LOAD( "sr-16_hack03.n1", 0x08000, 0x4000, CRC(4d5ed5e5) SHA1(a66e979d8a6ed9cae77c8415130c5f17f8149eda) )
	ROM_LOAD( "sr-17_hack03.n2", 0x0c000, 0x4000, CRC(8f4a1688) SHA1(69bab8f167a47eee34dadf56b1727b414f3e6579) )
...
// 1942
GAME( 2015, 1942hack01, 1942, _1942, 1942, _1942_state, driver_init, ROT270, "Minwah",                "1942 (With C64 music)", MACHINE_SUPPORTS_SAVE )
GAME( 2015, 1942hack02, 1942, _1942, 1942, _1942_state, driver_init, ROT270, "cmonkey",               "1942 (With Attract Mode In Free Play)", MACHINE_SUPPORTS_SAVE )
GAME( 1984, 1942hack03, 1942, _1942, 1942, _1942_state, driver_init, ROT270, "Jerky and Chris Moore", "1942 (Galaga X)", MACHINE_SUPPORTS_SAVE )
