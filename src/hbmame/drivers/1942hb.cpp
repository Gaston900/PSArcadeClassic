...
ROM_START( 1942hc01 )
	...
	ROM_LOAD( "sr-01_hc01.c11", 0x0000, 0x4000, CRC(4ee7ab6b) SHA1(609d2d9124da47d305c15ee034efd64a73adc1c0) )
...
ROM_START( 1942hc02 )
	...
	ROM_REGION( 0x2000, "gfx1", 0 )
	ROM_LOAD( "sr-02_hc02.f2", 0x00000, 0x2000, CRC(b3e1862b) SHA1(736fbef1ef15892ba6ea87be5366abf520e3d5fd) )
	...
	ROM_REGION( 0x10000, "gfx3", 0 )
	ROM_LOAD( "sr-14_hc02.l1", 0x00000, 0x4000, CRC(8408b932) SHA1(bea9d62156c566e7a3ae296e3e411d5542b7544b) )
	ROM_LOAD( "sr-15_hc02.l2", 0x04000, 0x4000, CRC(2218cb80) SHA1(5dd05b59a55804bedf637abb339188e9c9e6037a) )
	ROM_LOAD( "sr-16_hc02.n1", 0x08000, 0x4000, CRC(4d5ed5e5) SHA1(a66e979d8a6ed9cae77c8415130c5f17f8149eda) )
	ROM_LOAD( "sr-17_hc02.n2", 0x0c000, 0x4000, CRC(8f4a1688) SHA1(69bab8f167a47eee34dadf56b1727b414f3e6579) )
...
// Hack/Homebrow
GAME( 2015, 1942hc01,    1942,   _1942,    1942, _1942_state, driver_init, ROT270,  "hack",       "1942 (With C64 music)", MACHINE_SUPPORTS_SAVE )
