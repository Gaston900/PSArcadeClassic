...
// Bagman Turbo
GAME(1991, bagturbo, bagman, bagman, bagman, bagman_state, empty_init, ROT270, "hack",    "Bagman Turbo (Stern set 1) [c]", MACHINE_SUPPORTS_SAVE ) // http://www.arcadecollecting.com/hacks/bagman
// Pickin
GAME(1983, pickinpi, pickin, pickin, pickin, pickin_state, empty_init, ROT270, "hack",    "Pickin' (Color Hack)", MACHINE_SUPPORTS_SAVE )
