...
ROM_START( bloodbrohack01 )
	ROM_REGION( 0x80000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "2_hack01.u021.7n",  0x00001, 0x20000, CRC(e5724503) SHA1(eca13cd75f776cd82bd16574ff44a1a5462311ab) )
	ROM_LOAD16_BYTE( "1_hack01.u022.8n",  0x00000, 0x20000, CRC(8855bc32) SHA1(d322c339f284bd53d6753f816c3f5054be12a497) )
...
// Blood Bros
GAME( 2009, bloodbrohack01,  bloodbro, bloodbro, bloodbro, bloodbro_state, empty_init, ROT0, "pipi899", "Blood Bros (Ex Super Version 2009-03-09)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
