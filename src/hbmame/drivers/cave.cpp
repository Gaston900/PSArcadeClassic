...
ROM_START( plegendshc04 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "prog_hc04.u45", 0x000000, 0x80000, CRC(5472d7ba) SHA1(51f130d8266d531ceb71e7a3bdf140baed23a62d) )
	ROM_LOAD16_BYTE( "prog_hc04.u44", 0x000001, 0x80000, CRC(5dc7302f) SHA1(9c110c47107ad6314587acc4206beee9ec690326) )
	ROM_LOAD16_BYTE( "pr12.u2",  0x100000, 0x80000, CRC(0e202559) SHA1(217a8e47d5c679aff02ca43de1641230e4f78b01) )
	ROM_LOAD16_BYTE( "pr12.u3",  0x100001, 0x80000, CRC(54742f21) SHA1(fae7bb7381478eb077f0409acd521f77417aa968) )
...
ROM_START( pwrinst2hc01 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "g02_hc01.u45", 0x000000, 0x80000, CRC(f8e7a8e6) SHA1(bc6fe2afc54959aede8773899ca7b634dd67664d) )
	ROM_LOAD16_BYTE( "g02_hc01.u44", 0x000001, 0x80000, CRC(0dc84ee4) SHA1(07db5929e4c9298c414c5b4935f086d5f51bcd1c) )
...
ROM_START( sailormnhc02 ) //sailormnyy
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hc02.u45", 0x000000, 0x080000, CRC(89ac00db) SHA1(78d5fe67e64f880b4615e6df98f3738832ad7070) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhc03 ) //sailormnffj
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hc03.u45", 0x000000, 0x080000, CRC(f11bd75a) SHA1(7d4843331d1f01596bf7b341a290417256cd23e6) )
	ROM_IGNORE( 0x80000 )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhc06 ) //sailormnhfhx
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hc06.u45", 0x000000, 0x080000, CRC(db46ed23) SHA1(58a315ebde641592ab7e174a0f7b28645773bf8d) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhc07 ) //sailormnsl
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hc07.u45", 0x000000, 0x080000, CRC(e820d513) SHA1(1c67df455ad910dc4600997c580af39dfb62970b) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
/* Cave Hack */
GAME( 2022, agallethc01,    agallet,        sailormn,         cave,     cave_state, init_agallet,   ROT270, "DDJ",        "Air Gallet (Infinite Power 2022-08-07)", MACHINE_SUPPORTS_SAVE )
GAME( 2022, ddonpachhc01,   ddonpach,       ddonpach,         cave,     cave_state, init_ddonpach,  ROT270, "DDJ",        "DoDonPachi (Infinite Power 2022-08-07)", MACHINE_SUPPORTS_SAVE )
GAME( 2022, espradehc01,    esprade,        esprade,          cave,     cave_state, init_esprade,   ROT270, "DDJ",        "ESP Ra.De. (Infinite Power 2022-08-07)", MACHINE_SUPPORTS_SAVE )
GAME( 2023, espradehc02,    esprade,        esprade,          cave,     cave_state, init_esprade,   ROT270, "GOTVG",      "ESP Ra.De. (Korean/French 2023-11-29)", MACHINE_SUPPORTS_SAVE )
GAME( 2023, espradehc03,    esprade,        esprade,          cave,     cave_state, init_esprade,   ROT270, "GOTVG",      "ESP Ra.De. (Hybrid 2023-11-29)", MACHINE_SUPPORTS_SAVE )
GAME( 2023, espradehc04,    esprade,        esprade,          cave,     cave_state, init_esprade,   ROT270, "GOTVG",      "ESP Ra.De. (Ten-Loli 2023-11-29)", MACHINE_SUPPORTS_SAVE )
GAME( 2022, feversoshc01,   feversos,       dfeveron,         cave,     cave_state, init_feversos,  ROT270, "DDJ",        "Fever SOS (Infinite Power 2022-08-07)", MACHINE_SUPPORTS_SAVE )
GAME( 2023, feversoshc02,   feversos,       dfeveron,         cave,     cave_state, init_feversos,  ROT270, "GOTVG",      "Fever SOS (Korean/French Ten-Loli 2023-12-13)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, gaiahc01,       gaia,           gaia,             gaia,     cave_state, init_gaia,      ROT0,   "GOTVG",      "Gaia Crusaders (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, guwangehc01,    guwange,        guwange,          guwange,  cave_state, init_guwange,   ROT270, "DDJ",        "Guwange (Infinite Power 2022-08-07)",  MACHINE_SUPPORTS_SAVE )
GAME( 1995, metmqstrhc01,   metmqstr,       metmqstr,         metmqstr, cave_state, init_metmqstr,  ROT0,   "hack",       "Metamoqester (Korean Translation)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1995, metmqstrhc03,   metmqstr,       metmqstr,         metmqstr, cave_state, init_metmqstr,  ROT0,   "DDJ",        "Metamoqester (Easy Special Attacks)",   MACHINE_SUPPORTS_SAVE )
GAME( 2023, plegendshc01,   plegends,       pwrinst2,         metmqstr, cave_state, init_pwrinst2j, ROT0,   "GOTVG",      "Gouketsuji Gaiden (Infinite Energy 2023-08-21)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1995, plegendshc03,   plegends,       pwrinst2,         metmqstr, cave_state, init_pwrinst2j, ROT0,   "DDJ",        "Gouketsuji Gaiden (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, plegendshc04,   plegends,       pwrinst2,         metmqstr, cave_state, init_pwrinst2j, ROT0,   "DDJ",        "Gouketsuji Gaiden (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, pwrinst2hc01,   pwrinst2,       pwrinst2,         metmqstr, cave_state, init_pwrinst2,  ROT0,   "hack",       "Power Instinct 2 (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
