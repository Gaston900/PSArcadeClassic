...
ROM_START( ddonpachhack01 ) // Ship Colour Additions and Music Mute, created by Olifante
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "u27_hack01.bin", 0x000000, 0x080000, CRC(8faf593f) SHA1(79f2252a14651662e1cbceb3a6c06c80263a2e96) )
	ROM_LOAD16_BYTE( "u26_hack01.bin", 0x000001, 0x080000, CRC(259fb1a3) SHA1(d4e5bfb17c4e1928597225813e874677f51dff00) )
...
ROM_START( gaiahack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "prg1.127", 0x000000, 0x080000, CRC(47b904b2) SHA1(58b9b55f59cf00f70b690a0371096e86f4d723c2) )
	ROM_LOAD16_BYTE( "prg2_hack01.128", 0x000001, 0x080000, CRC(442b047d) SHA1(752f33b631e40ccbab7670501926144841f0b6cd) )
...
ROM_START( metmqstrhack01 )
	ROM_REGION( 0x280000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bp947a_hack01.u25", 0x000000, 0x80000, CRC(748cc514) SHA1(11d882e77a539407c314f087386e50d691a6bc0b) )
...
ROM_START( metmqstrhack02 )
	ROM_REGION( 0x280000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bp947a_hack02.u25", 0x000000, 0x80000, CRC(1b3f7a53) SHA1(36c23c33eb72a96af08ff104bb3463482c3651f9) )
	ROM_LOAD16_WORD_SWAP( "bp947a.u28", 0x100000, 0x80000, CRC(8c55decf) SHA1(76c6ce4c8e621273258d31ceb9ec4442fcf1a393) )
	ROM_LOAD16_WORD_SWAP( "bp947a.u29", 0x200000, 0x80000, CRC(cf0f3f3b) SHA1(49a3c0e7536edd53bbf09353e43e9166d736b3f4) )
...
ROM_START( theroehack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "t-hero-epm1_hack01.u0127", 0x000000, 0x080000, CRC(8d5961d1) SHA1(69cb82c3d269f641840f17fd7237d0744d01405e) )
	ROM_LOAD16_BYTE( "t-hero-epm0_hack01.u0129", 0x000001, 0x080000, CRC(89dc3ad3) SHA1(8652f2b93d5b4fe1a4d88cb39c9821f0739bfeff) )
...
ROM_START( plegendshack01 ) //plegendsjl
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "pr12_hack01.u45", 0x000000, 0x80000, CRC(fd042fa5) SHA1(a3677d750d7baab56baf5e2f55a987fb99d8f3ac) )
	ROM_LOAD16_BYTE( "pr12_hack01.u44", 0x000001, 0x80000, CRC(72210eb7) SHA1(63dc4cd63bd308e2f6a95cea78c9ba5c45c2baf3) )
...
ROM_START( pwrinst2hack01 ) //pwrinst2l
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "g02_hack01.u45", 0x000000, 0x80000, CRC(652218b1) SHA1(90133f290636c28aaff7393dcbd196119e67e9c1) )
	ROM_LOAD16_BYTE( "g02_hack01.u44", 0x000001, 0x80000, CRC(c427afa1) SHA1(b127bf394c7a1b064cdaf4f78de5c068151057ef) )
...
ROM_START( sailormnhack01 )   // Brutal version
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack01.u45", 0x000000, 0x080000, CRC(b282dc5e) SHA1(117c0326b50a0e0986c9e1f0b84a3c0b21c95275) )
...
ROM_START( sailormnhack02 )   // Real Threat
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack02.u45", 0x000000, 0x080000, CRC(bff1a803) SHA1(6bf6006a3ed25274f6527f8643dc939e25678c06) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack03 )   // "Directors" Cut
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack03.u45", 0x000000, 0x080000, CRC(2ed54038) SHA1(bda38ea7488e99ef88105aa249d5ae8c42d0336c) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack04 )
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack04.u45", 0x000000, 0x080000, CRC(0e7f4981) SHA1(45b35b59c1cacc146f64c3233f3bb788d98863f0) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack05 )
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack05.u45", 0x000000, 0x080000, CRC(5612a3c7) SHA1(c8be803904c03f932459dc6ffd6a56cacfbe2f10) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack06 ) //sailormnoh
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack06.u45", 0x000000, 0x080000, CRC(e77a6fbe) SHA1(0fd65be4585fac68c73dd0d1141ca3283d087523) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack07 ) //sailormnn
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack07.u45", 0x000000, 0x080000, CRC(eaf9da46) SHA1(10b980d3b535c7e5b8d217984575a8223f1ebac2) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack08 ) //sailormnoj
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack08.u45", 0x000000, 0x080000, CRC(7a6f5434) SHA1(83a935d357865030c2ff8b9a980bdacd00807c0e) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
ROM_START( sailormnhack09 )   // Reign of Terror
	ROM_REGION( 0x400000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "bpsm945_hack09.u45",  0x000000, 0x080000, CRC(daf0db76) SHA1(68e648f57219925f328575e9a513e67ca79a67df) )
	ROM_LOAD16_WORD_SWAP( "bpsm.u46",     0x200000, 0x200000, CRC(32084e80) SHA1(0ac503190d95009620b5ad7e7e0e63324f6fa4eb) )
...
// DoDonPachi
GAME( 2021, ddonpachhack01,   ddonpach, ddonpach,   cave,     cave_state,     init_ddonpach,  ROT270,  "Olifante",       "DoDonPachi (Japan, hack)", MACHINE_SUPPORTS_SAVE )
// Gaia Crusaders
GAME( 1999, gaiahack01,       gaia,     gaia,       gaia,     cave_state,     init_gaia,      ROT0,    "O Day-S",        "Gaia Crusaders (Enable Secret Character)", MACHINE_SUPPORTS_SAVE | MACHINE_IMPERFECT_SOUND )
// Metamoqester
GAME( 1995, metmqstrhack01,   metmqstr, metmqstr,   metmqstr, cave_state,     init_metmqstr,  ROT0,    "Aneue Bannzai",  "Metamoqester (Translation Korean)",   MACHINE_SUPPORTS_SAVE )
GAME( 1995, metmqstrhack02,   metmqstr, metmqstr,   metmqstr, cave_state,     init_metmqstr,  ROT0,    "DDJ",            "Metamoqester (Always Have Super Move)",   MACHINE_SUPPORTS_SAVE )
// Thunder Heroes
GAME( 2001, theroehack01,     theroes,  gaia,       theroes,  cave_state,     init_gaia,      ROT0,    "pipi899",        "Thunder Heroes (Select Characters 2009-08-19)", MACHINE_SUPPORTS_SAVE | MACHINE_IMPERFECT_SOUND )
// Gouketsuji Gaiden
GAME( 2018, plegendshack01,   plegends, pwrinst2,   metmqstr, cave_state,     init_pwrinst2j, ROT0,    "hack",           "Gouketsuji Gaiden (Simplify Edition 2018-06-04)", MACHINE_SUPPORTS_SAVE )
// Power Instinct 2
GAME( 2018, pwrinst2hack01,   pwrinst2, pwrinst2,   metmqstr, cave_state,     init_pwrinst2,  ROT0,    "hack",           "Power Instinct 2 (Simplify Edition 2018-06-04)", MACHINE_SUPPORTS_SAVE )
// Pretty Soldier Sailor Moon
GAME( 2021, sailormnhack01,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "ZombieMaster",   "Pretty Soldier Sailor Moon (Brutal Version)", MACHINE_SUPPORTS_SAVE )
GAME( 2021, sailormnhack02,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "ZombieMaster",   "Pretty Soldier Sailor Moon (Real Threat)", MACHINE_SUPPORTS_SAVE )
GAME( 2021, sailormnhack03,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "ZombieMaster",   "Pretty Soldier Sailor Moon (Director's Cut v1.4)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, sailormnhack04,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "hack",           "Pretty Soldier Sailor Moon (Increases The Difficulty 2018-04-19)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, sailormnhack05,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "pipi899",        "Pretty Soldier Sailor Moon (Enhanced Magic 2009-02-24)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, sailormnhack06,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "hack",           "Pretty Soldier Sailor Moon (Enhanced Edition 2019-12-15)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, sailormnhack07,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "hack",           "Pretty Soldier Sailor Moon (Enemy Demon Revised Edition 2020-05-24)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, sailormnhack08,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "hack",           "Pretty Soldier Sailor Moon (Rabbit Edition 2020-09-17)", MACHINE_SUPPORTS_SAVE )
GAME( 2022, sailormnhack09,   sailormn, sailormn,   cave,     cave_state,     init_sailormn,  ROT0,    "ZombieMaster",   "Pretty Soldier Sailor Moon (Reign of Terror) v1.6", MACHINE_SUPPORTS_SAVE )
