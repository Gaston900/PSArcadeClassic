...
ROM_START( sfiii3hc01 ) //sfiii4fs
	ROM_REGION32_BE( 0x080000, "bios", 0 )
	ROM_LOAD( "sfiii3_japan_nocd.29f400.u2", 0x000000, 0x080000, CRC(1edc6366) SHA1(60b4b9adeb030a33059d74fdf03873029e465b52) )

	ROM_REGION( 0x200000, "simm1.0", 0 )
	ROM_LOAD( "sfiii3-simm1_hc01.0", 0x00000, 0x200000, CRC(cd044113) SHA1(fef4984e1405ab4a9f5766bd58c1423a7240d98d) )
	ROM_REGION( 0x200000, "simm1.1", 0 )
	ROM_LOAD( "sfiii3-simm1_hc01.1", 0x00000, 0x200000, CRC(b6334750) SHA1(ee0cf07e5351c327dc9557f01ede929888ebd6a9) )
	ROM_REGION( 0x200000, "simm1.2", 0 )
	ROM_LOAD( "sfiii3-simm1_hc01.2", 0x00000, 0x200000, CRC(48fed039) SHA1(c6b269958d431dde454faf3e62f7a16c572121a3) )
	ROM_REGION( 0x200000, "simm1.3", 0 )
	ROM_LOAD( "sfiii3-simm1_hc01.3", 0x00000, 0x200000, CRC(130a29b5) SHA1(612db08632fbef32f5b076c4fa462123468f789a) )
...
ROM_START( sfiii3hc04 ) //sfiii4n
	...
	ROM_REGION( 0x200000, "simm1.0", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.0", 0x00000, 0x200000, CRC(ca97f95e) SHA1(624f1af8c3722c0554a65bfb4f0682ed66a70b55) )
	ROM_REGION( 0x200000, "simm1.1", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.1", 0x00000, 0x200000, CRC(5bc7faa6) SHA1(291b6102d8ad7478ea45e73d34ad8d65332beaf0) )
	ROM_REGION( 0x200000, "simm1.2", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.2", 0x00000, 0x200000, CRC(ec2eaa29) SHA1(981d452f15da43d4577339ab5799c7561f298d62) )
	ROM_REGION( 0x200000, "simm1.3", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.3", 0x00000, 0x200000, CRC(41c4ce7c) SHA1(273f21735200becb0da06ab3e40023918df2a062) )
...
ROM_START( sfiii3hc05 )
	...
	ROM_REGION32_BE( USER4REGION_LENGTH, "old4", ROMREGION_ERASEFF )
	ROM_LOAD( "10_hc05",  0x0000000, 0x800000, CRC(b18be430) SHA1(0ede4ab7c950dc838e01b8df9b9ddd725ff640ee) )
...
ROM_START( sfiii3hc06 ) //sfiii3th
	...
	ROM_LOAD( "sfiii3-simm5.5", 0x00000, 0x200000, CRC(8ccad9b1) SHA1(f8bda399f87be2497b7ac39e9661f9863bf4f873) )
	ROM_REGION( 0x200000, "simm5.6", 0 )
	ROM_LOAD( "sfiii3-simm5_hc06.6", 0x00000, 0x200000, CRC(7fffb6d4) SHA1(5212d7d3e5228be8354bade969c5612d1c7a62cc) )
	ROM_REGION( 0x200000, "simm5.7", 0 )
	ROM_LOAD( "sfiii3-simm5_hc06.7", 0x00000, 0x200000, CRC(2dfcd4a6) SHA1(62a8bfc619ed6e1c4e50f7206188d7b5c54d763b) )
...
// Hack
GAME( 2018, jojobahc01,     jojoba,   jojoba,        cps3_jojo,  cps3_hbmame,     init_jojoban,  ROT0,      "hack",        "JoJo's Bizarre Adventure (Enable Hidden Characters)", 0 ) // Hack Old Roms
GAME( 2018, jojobahc02,     jojoba,   jojoba,        cps3_jojo,  cps3_state,      init_jojoba,   ROT0,      "hack",        "JoJo's Bizarre Adventure (Easy Move)", 0 )
...
GAME( 2009, redeartnhc01,   redearth, redeartn,      cps3_ren,   cps3_hbmame,     init_redeartno,ROT0,      "hack",        "Red Earth (Ex Super Version 2009-09-08)", 0 ) // Hack Old Roms
GAME( 2016, sfiiihc01,      sfiii,    sfiii,         cps3,       cps3_state,      init_sfiii,    ROT0,      "hack",        "Street Fighter III: New Generation (Easy Move)", 0 )
...
GAMEL(2016, sfiii2hc02,     sfiii2,   sfiii2,        cps3,       cps3_state,      init_sfiii2,   ROT0,      "hack",        "Street Fighter III 2nd Impact: Giant Attack (Easy Move)", 0, layout_sfiii2 )
...
GAME( 2014, sfiii3hc03,     sfiii3,   sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (Easy Move)", 0 )
...
/*    YEAR  NAME            PARENT    MACHINE        INPUT       CLASS                INIT      MONITOR     COMPANY        FULLNAME FLAGS */
// Capcom Old
GAME( 1999, jojobatn,       jojoba,   jojoba,        cps3_jojo,  cps3_hbmame,     init_jojoban,  ROT0,      "Capcom",      "JoJo's Bizarre Adventure (Euro 990913, NO CD / OLD)", 0 )
GAME( 1998, jojotn,         jojo,     jojo,          cps3_jojo,  cps3_hbmame,     init_jojon,    ROT0,      "Capcom",      "JoJo's Venture (Asia 990108, NO CD / OLD)", 0 )
GAME( 1996, redeartn,       redearth, redeartn,      cps3_ren,   cps3_hbmame,     init_redeartno,ROT0,      "Capcom",      "Red Earth (Asia 961121, NO CD / OLD)", 0 )
GAME( 1997, sfiiitn,        sfiii,    sfiii,         cps3,       cps3_hbmame,     init_sfiiin,   ROT0,      "Capcom",      "Street Fighter III: New Generation (Asia 970204, NO CD / OLD)", 0 )
GAMEL(1997, sfiii2tn,       sfiii2,   sfiii2,        cps3,       cps3_hbmame,     init_sfiii2n,  ROT0,      "Capcom",      "Street Fighter III 2nd Impact: Giant Attack (Asia 970930, NO CD / OLD)", 0, layout_sfiii2 )
GAME( 1999, sfiii3tn,       sfiii3,   sfiii3,        cps3,       cps3_hbmame,     init_sfiii3n,  ROT0,      "Capcom",      "Street Fighter III 3rd Strike: Fight for the Future (Japan 990608, NO CD / OLD)", 0 )
