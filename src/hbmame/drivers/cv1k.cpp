...
GAME( 2011, msmatsuri,   0,        cv1k,   cv1k, cv1k_state, init_mushisam, ROT270, "Cave (AMI license)",   "Mushihime-Sama Matsuri (Japan, 2011-05-23 CAVEMATSURI VER1.5)", MACHINE_SUPPORTS_SAVE )
