...
ROM_START( dbzhack01 )
	...
	ROM_LOAD16_BYTE( "222b11_hack01.9e", 0x000000, 0x80000, CRC(7b545f5e) SHA1(5b01564f66d01ad4c711d4d309b7b3f49053fc4c) )
	ROM_IGNORE(0x3D4F47)
	ROM_LOAD16_BYTE( "222b12_hack01.9f", 0x000001, 0x80000, CRC(64e3d243) SHA1(25f3022e50e1142a09fd5c5fda983a52d13ef13a) )
	ROM_IGNORE(0x3D4F47)
...
ROM_START( dbz2hack01 )
	ROM_REGION( 0x400000, "maincpu", 0)
	ROM_LOAD16_BYTE( "a9e_hack01.9e", 0x000000, 0x80000, CRC(c64a637c) SHA1(ce2976f4c2f5408aa702daaf1520aeb19e2a1b54) )
	ROM_LOAD16_BYTE( "a9f_hack01.9f", 0x000001, 0x80000, CRC(dbb75c77) SHA1(2f6ede30e36bbaa54d55acc86d18cd66da0ec281) )
...
// Dragon Ball Z
GAME( 2016, dbzhack01,     dbz,  dbz, dbz,  dbz_state, init_dbz,  ROT0, "hack", "Dragon Ball Z (Simple Attack)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_SUPPORTS_SAVE )
// Dragon Ball Z 2
GAME( 2009, dbz2hack01,    dbz2, dbz, dbz2, dbz_state, init_dbz2, ROT0, "hack", "Dragon Ball Z 2 (Simple Attack)", MACHINE_SUPPORTS_SAVE )
