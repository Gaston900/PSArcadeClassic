...
ROM_START( exerionhack01 )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "exerion_hack01.07",  0x0000, 0x2000, CRC(0ade934a) SHA1(a949aa66f27876ca439b799a9918841f7d8d3115) )
	ROM_LOAD( "exerion_hack01.08",  0x2000, 0x2000, CRC(a469f93e) SHA1(7e800e4c0dce2b9c9525dc1667ca13f1b2844d9b) )
	ROM_LOAD( "exerion_hack01.09",  0x4000, 0x2000, CRC(f0a8d5db) SHA1(df0f18ebef27a70ef420903a02ec5ce3c43d1d8b) )
...
ROM_START( exerionhack02 )
	...
	ROM_REGION( 0x0420, "proms", 0 )
	ROM_LOAD( "exerion_hack02.e1",  0x0000, 0x0020, CRC(60cec362) SHA1(2422e894e2def2ab31f4b6c14fabbe443bd495e6) )
	ROM_LOAD( "exerion.i8",   0x0020, 0x0100, CRC(31db0e08) SHA1(1041a778e86d3fe6f057cf40a0a08b30760f3887) )
	ROM_LOAD( "exerion.h10",  0x0120, 0x0100, CRC(63b4c555) SHA1(30243041be4fa77ada71e8b29d721cad51640c29) )
	ROM_LOAD( "exerion.i3",   0x0220, 0x0100, CRC(fe72ab79) SHA1(048a72e6db4768df687df927acaa70ef906b3dc0) )
	ROM_LOAD( "exerion.k4",   0x0320, 0x0100, CRC(ffc2ba43) SHA1(03be1c41d6ac3fc11439caef04ef5ffa60d6aec4) )
...
// Exerion
GAME( 2004, exerionhack01,  exerion, exerion, exerion, exerion_state, init_exerion,  ROT90, "GreekRoms", "Exerion (Greek)", MACHINE_SUPPORTS_SAVE )
GAME( 1983, exerionhack02,  exerion, exerion, exerion, exerion_state, init_exerion,  ROT90, "Jaleco",    "Exerion (Japan)", MACHINE_SUPPORTS_SAVE )
