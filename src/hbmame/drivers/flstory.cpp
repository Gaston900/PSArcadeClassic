...
ROM_START( flstoryhack01 )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cpu-a45_hack01.15",   0x0000, 0x4000, CRC(1be138fa) SHA1(eaf3b2810d7f4a95930024ec440bf2ba59230e2d) )
	ROM_LOAD( "cpu-a45_hack01.16",   0x4000, 0x4000, CRC(74b3f227) SHA1(f8ba5c5db92cda691febecdf62b148157adf744a) )
	ROM_LOAD( "cpu-a45_hack01.17",   0x8000, 0x4000, CRC(1309b079) SHA1(0b82af55273aba6433a789b1d6cfbda650ab85c9) )
...
// The FairyLand Story
GAME( 1985, flstoryhack01,  flstory,  flstory,      flstory,  flstory_state, empty_init, ROT180, "hack", "The FairyLand Story (Translation Chinese)", MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
