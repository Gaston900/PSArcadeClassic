...
ROM_START( asurabldhack01 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE( "pgm3_hack01.u1", 0x000000, 0x80000, CRC(e65f2f19) SHA1(d2d9735842010fb3f9cb85a9255172db3a93937d) )
	ROM_LOAD32_BYTE( "pgm2_hack01.u2", 0x000001, 0x80000, CRC(67e608d3) SHA1(0bc7b9e9fefb0d0f35afb5dae40b25300a00b543) )
	ROM_LOAD32_BYTE( "pgm1_hack01.u3", 0x000002, 0x80000, CRC(85ec63ae) SHA1(768e4f1da9e126f94873a2e6c6a304643143faea) )
	ROM_LOAD32_BYTE( "pgm0_hack01.u4", 0x000003, 0x80000, CRC(a9a90415) SHA1(7445ad491a1f6c7733f0ee79e912fd186f8ae222) )
...
ROM_START( asurabldhack02 ) //asurabldl
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE( "pgm3_hack02.u1", 0x000000, 0x80000, CRC(65331e9b) SHA1(e7bc5636a4ffd5abef68b38ff1cbb58fd821e2aa) )
	ROM_LOAD32_BYTE( "pgm2_hack02.u2", 0x000001, 0x80000, CRC(4cadb90a) SHA1(15a91eeae818368d5757e6891da7e295eb74ba87) )
	ROM_LOAD32_BYTE( "pgm1_hack02.u3", 0x000002, 0x80000, CRC(208d7893) SHA1(80fd9a3e9be1ea920fc9ec760b325fccb0d29b0f) )
	ROM_LOAD32_BYTE( "pgm0_hack02.u4", 0x000003, 0x80000, CRC(1657a971) SHA1(c838de7c45e9ed3b5809c52e792b8a70cf1378c2) )
...
ROM_START( asurabushack01 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE( "pgm3_hack01.u1", 0x000000, 0x80000, CRC(dd9df251) SHA1(8ed4ddaefe7b4f6760d884963bd593ce88c991d9) )
	ROM_LOAD32_BYTE( "pgm2_hack01.u2", 0x000001, 0x80000, CRC(2e360db2) SHA1(f9489cac523109aada2fa58f0e43130d9c537bd2) )
	ROM_LOAD32_BYTE( "pgm1_hack01.u3", 0x000002, 0x80000, CRC(71c4fcfc) SHA1(b0ed5302393b196f11f042e4b0964495e799bb6e) )
	ROM_LOAD32_BYTE( "pgm0_hack01.u4", 0x000003, 0x80000, CRC(44a33fcb) SHA1(97a0bc3922049a99ae3c71bd9dcea04ccc7237ba) )
...
// Asura Blade - Sword of Dynasty
GAME( 1998, asurabldhack01, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "yumeji", "Asura Blade - Sword of Dynasty (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, asurabldhack02, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "hack",   "Asura Blade - Sword of Dynasty (Simplified Edition 2018-06-04)", MACHINE_SUPPORTS_SAVE )
// Asura Buster
GAME( 2000, asurabushack01, asurabus, fuuki32, asurabusa,fuuki32_state, empty_init, ROT0, "yumeji", "Asura Buster (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
