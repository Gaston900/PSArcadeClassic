...
ROM_START( vectrgal )
	...
	ROM_REGION( 0x1000, "gfx1", 0 )
	ROM_LOAD( "vectrgal.1h", 0x0000, 0x0800, CRC(02815aec) SHA1(94975ee5eff84a3ae483dd3d5766384859402477) )
	ROM_LOAD( "vectrgal.1k", 0x0800, 0x0800, CRC(11c9898c) SHA1(fb6bac221b3984a70a775bccf06f6e2f17d447cf) )
...
ROM_START( galinvad )
	...
	ROM_REGION( 0x1000, "gfx1", 0 )
	ROM_LOAD( "galinvad.1h", 0x0000, 0x0800, CRC(d3d42377) SHA1(4eae6b2b20cfb6841d679006f394c7081f8f426f) )
	ROM_LOAD( "galinvad.1k", 0x0800, 0x0800, CRC(7e515c84) SHA1(e15ff199f1db55e9abb30c403fc667a4e7143b4f) )
...
ROM_START( gaylaxn )
	...
	ROM_REGION( 0x1000, "gfx1", 0 )
	ROM_LOAD( "gaylaxn.1h",   0x0000, 0x0800, CRC(ce77d89b) SHA1(17de678c91e96bf3dc414cc2ad8631a8f617da3d) )
	ROM_LOAD( "gaylaxn.1k",   0x0800, 0x0800, CRC(08008d2c) SHA1(6600dbc42e5076f9ce3abe677134bf1677ae70ea) )
...
ROM_START( amidargr ) // greek
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "amidargr.2c",   0x0000, 0x1000, CRC(e9822709) SHA1(ce7c76607a512b9b092a8bf83bdf6744a92a519a) )
	ROM_LOAD( "amidar.2e",     0x1000, 0x1000, CRC(e6e96826) SHA1(e9c4f8c594640424b456505e676352a98b758c03) )
	ROM_LOAD( "amidargr.2f",   0x2000, 0x1000, CRC(fd81b040) SHA1(f710cb192a50514f55b4aec859fd9c298b0b90f8) )
	ROM_LOAD( "amidar.2h",     0x3000, 0x1000, CRC(1be170bd) SHA1(c047bc393b297c0d47668a5f6f4870e3fac937ef) )
	...
	ROM_REGION( 0x1000, "gfx1", 0 )
	ROM_LOAD( "amidar.5f",     0x0000, 0x0800, CRC(5e51e84d) SHA1(dfe84db7e2b1a45a1d484fcf37291f536bc5324c) )
	ROM_LOAD( "amidargr.5h",   0x0800, 0x0800, CRC(141f8dbe) SHA1(3a627f5dd072909177f50920271f0d8ffb8a09c0) )
...
GAME( 2004, frogtest,   frogger,  tst_frog, frogger,  galaxian_hbmame, init_frogger,  ROT90, "msmcdoug / JROK", "Frogger Sound Test (HB)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, frogtest2,  frogger,  frogger,  frogger,  galaxian_hbmame, init_frogger,  ROT90, "Phil Murray", "Frogger Test Rom (HB)", MACHINE_SUPPORTS_SAVE )
...
// Amidar
GAME( 2007, amidarf,   amidar,   turtles,  amidar,   galaxian_hbmame, init_turtles,  ROT90, "S.Arkames", "Amidar (French Translation)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2004, amidargr,   amidar,   turtles,  amidar,   galaxian_hbmame, init_turtles,  ROT90, "GreekRoms", "Amidar (Greek Translation)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2019, scratest,   scramble, scramble, scramble, galaxian_hbmame, init_scramble, ROT90, "Phil Murray", "Scramble Test Rom (HB)", MACHINE_SUPPORTS_SAVE )


// Super Cobra
GAME( 2019, scobtest,   scobra,   scobra,   scobra,   galaxian_state,  init_scobra,   ROT90, "Phil Murray", "Super Cobra Test Rom (HB)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2017, galxtest2,  galnamco, galaxian, galaxian, galaxian_state,  init_galaxian, ROT90, "Phil Murray", "Galaxian Test Rom (HB)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2017, moontest,   mooncrst, mooncrst, mooncrst, galaxian_hbmame, init_mooncrsu, ROT90, "Phil Murray", "Moon Cresta Test Rom (HB)", MACHINE_SUPPORTS_SAVE )
