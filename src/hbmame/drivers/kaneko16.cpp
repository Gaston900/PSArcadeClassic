...
ROM_START( bloodwarhack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )       
	ROM_LOAD16_BYTE( "ofp0f3_hack01.514", 0x000000, 0x080000, CRC(e0d56791) SHA1(275d6273525536a3db286c71ba3602a7705179ac) )
	ROM_LOAD16_BYTE( "ofp1f3_hack01.513", 0x000001, 0x080000, CRC(e9c84790) SHA1(6bd7525d7c90de1fb3ed68310298ecaa5462f659) )
...
ROM_START( shogwarrhack01 )
	ROM_REGION( 0x040000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "fb030e_hack01.u61", 0x000000, 0x020000, CRC(c3a66037) SHA1(4ca1b440ca822d6c6adecb5c0a3d83126bc775a2) )
	ROM_LOAD16_BYTE( "fb030e_hack01.u62", 0x000001, 0x020000, CRC(e382acf8) SHA1(50177a525fb6138490c70e50f5b9ae476cb8d6de) )
...
ROM_START( shogwarrhack02 )
	ROM_REGION( 0x040008, "maincpu", 0 )      
	ROM_LOAD16_BYTE( "fb030e_hack02.u61", 0x000000, 0x020000, CRC(3b7393b5) SHA1(ef3a1d52bac11356d0cf410476c7726c4e0f6bdf) )
	ROM_LOAD16_BYTE( "fb030e_hack02.u62", 0x000001, 0x020000, CRC(41df237f) SHA1(8e92be40ab2eb9dd200af3d45b3f1aa8b94ddcc8) )
...
//Blood Warrior
GAME( 1994, bloodwarhack01,   bloodwar,        bloodwar, bloodwar,  kaneko16_gtmr_state,     init_gtmr,     ROT0,  "DDJ", "Blood Warrior (Easy Move)", MACHINE_SUPPORTS_SAVE )
// Shogun Warriors
GAME( 1992, shogwarrhack01,   shogwarr,        shogwarr, shogwarr,  kaneko16_shogwarr_state, init_shogwarr, ROT0,  "e107", "Shogun Warriors (Enable Hidden Characters) ", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, shogwarrhack02,   shogwarr,        shogwarr, shogwarr,  kaneko16_shogwarr_state, init_shogwarr, ROT0,  "hack", "Shogun Warriors (Simplified 2017-02-28)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
