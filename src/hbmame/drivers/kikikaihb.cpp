...
ROM_START( kikikaihc01 )
	ROM_REGION( 0x28000, "maincpu", 0 )
	ROM_LOAD( "a85-17_hc01.h16", 0x00000, 0x08000, CRC(2a13c079) SHA1(0c7b9a4598d5add28edca306a060268945aa8923) )
...
// Hack/Homebrow
GAME( 1986, kikikaihc01,  kikikai, kikikai,  kikikai,  kikikai_simulation_state, empty_init,   ROT90,   "hack",       "KiKi KaiKai (Translation Chinese)", MACHINE_SUPPORTS_SAVE )
