...
ROM_START( dragoonahc01 )
	ROM_REGION( 0x800000, "maincpu", 0 )
	GX_BIOS
	ROM_LOAD32_WORD_SWAP( "417aab02_hc01.31b", 0x200002, 512*1024, CRC(38d338b5) SHA1(239802338167b0f7a64d62ad230b46b58af3e46e) )
	ROM_LOAD32_WORD_SWAP( "417aab03_hc01.27b", 0x200000, 512*1024, CRC(520c29ff) SHA1(125feb1526a70bd315cee7aded77547b33d06dcd) )
...
ROM_START( dragoonahc02 )
	ROM_REGION( 0x800000, "maincpu", 0 )
	GX_BIOS
	ROM_LOAD32_WORD_SWAP( "417aab02_hc02.31b", 0x200002, 512*1024, CRC(b391f67e) SHA1(b7066b1aa5906056f84cae4dc639d69768f97d09) )
	ROM_LOAD32_WORD_SWAP( "417aab03_hc02.27b", 0x200000, 512*1024, CRC(3e0eded0) SHA1(7ec68b74271544f3c8690316a3829141c84c03e1) )
...
ROM_START( dragoonahc03 )
	ROM_REGION( 0x800000, "maincpu", 0 )
	GX_BIOS
	ROM_LOAD32_WORD_SWAP( "417aab02_hc03.31b", 0x200002, 512*1024, CRC(d4e6eace) SHA1(2bfb96e968359d0d9c227f89ad41457e95479b32) )
	ROM_LOAD32_WORD_SWAP( "417aab03_hc03.27b", 0x200000, 512*1024, CRC(bf4598c4) SHA1(d7ec625cf019eb41d5847945b66e9f33d895ec57) )
...
/* Konamigx Hack */
GAME( 1995, dragoonahc01,  dragoona, dragoonj,  dragoonj, konamigx_state, init_posthack, ROT0,    "hack",        "Dragoon Might (Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, dragoonahc02,  dragoona, dragoonj,  dragoonj, konamigx_state, init_posthack, ROT0,    "hack",        "Dragoon Might (Always Have Super Move)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, dragoonahc03,  dragoona, dragoonj,  dragoonj, konamigx_state, init_posthack, ROT0,    "hack",        "Dragoon Might (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
