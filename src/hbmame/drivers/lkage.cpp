...
ROM_START( lkagehack01 )
	ROM_REGION( 0x14000, "maincpu", 0 ) 
	ROM_LOAD( "a54-01-2_hack01.37", 0x0000, 0x8000, CRC(f3d05d57) SHA1(f890af7450890990aa8d82e874446f64a52e922c) )
	ROM_LOAD( "a54-02-2_hack01.38", 0x8000, 0x8000, CRC(c9d1220b) SHA1(2b5baa4ea3e169c65053e96b38adc376a33b2b6f) )
...
// The Legend of Kage
GAME( 1984, lkagehack01, lkage, lkage, lkage, lkage_state, init_lkage, ROT0, "hack", "The Legend of Kage (Translation Chinese)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
