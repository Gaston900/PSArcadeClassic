...
ROM_START( mkhack01 )
	...
	ROM_LOAD16_BYTE( "mkt-uj12_hack01.bin", 0x00000, 0x80000, CRC(4192e38f) SHA1(abe2e6f643a36df48a23aaa2f9027c78c6078d2d) )
	ROM_LOAD16_BYTE( "mkt-ug12_hack01.bin", 0x00001, 0x80000, CRC(8799979d) SHA1(4f094540e68c03fbd03cd8731797c55e455f61e6) )
...
ROM_START( mkhack02 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "mkt-uj12_hack02.bin", 0x00000, 0x80000, CRC(f4a9a289) SHA1(a94b0a5796457c6f2789e9fd5a1cb80fd6dcf22b) )
	ROM_LOAD16_BYTE( "mkt-ug12_hack02.bin", 0x00001, 0x80000, CRC(45bed5a1) SHA1(dba2c21878925afdcaf61520c18ebefd5e9617db) )
...
ROM_START( mkhack03 ) //mkk
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "mkt-uj12_hack03.bin", 0x00000, 0x80000, CRC(f04ded75) SHA1(0ba305c8b63085889e1827e5231ce08b5b1adb6c) )
	ROM_LOAD16_BYTE( "mkt-ug12_hack03.bin", 0x00001, 0x80000, CRC(30fd0268) SHA1(2336e5d8cbaaeb6b08f7c68c32af3d02492f81f8) )
...
ROM_START( mk2hack01 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hack01.131", 0x00000, 0x80000, CRC(0f801e9b) SHA1(b0dc620e1be6b89ff0a1dcd64eec678e81a2ea69) )
	ROM_LOAD16_BYTE( "ug12_hack01.131", 0x00001, 0x80000, CRC(d896c9b6) SHA1(61e26c6acaf810e0788aef31000056e524b87b06) )
...
ROM_START( mk2hack02 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hack02.131", 0x00000, 0x80000, CRC(05ff15a9) SHA1(23e9c47644c756d7568b6e5122801b19cf594e9b) )
	ROM_LOAD16_BYTE( "ug12_hack02.131", 0x00001, 0x80000, CRC(b6d8ff5c) SHA1(ad974cc0dcdf35c7175f7cb8c620b58b82843523) )
	...
	ROM_LOAD32_BYTE( "l1_mortal_kombat_ii_game_rom_ug16_hack02.ug16", 0x400000, 0x100000, CRC(b2af2798) SHA1(3d679fb59753b72f961fe60a65e4e03a76b64266) )
	ROM_LOAD32_BYTE( "l1_mortal_kombat_ii_game_rom_uj16_hack02.uj16", 0x400001, 0x100000, CRC(d70dd149) SHA1(1add61f22a68c0bd8dba3fa0da18f5ecc7f51c6f) )
	ROM_LOAD32_BYTE( "l1_mortal_kombat_ii_game_rom_ug20_hack02.ug20", 0x400002, 0x100000, CRC(d05e970a) SHA1(0f07d72c0ae9ed77c79b4a39abbc047df68a6b1d) )
	ROM_LOAD32_BYTE( "l1_mortal_kombat_ii_game_rom_uj20_hack02.uj20", 0x400003, 0x100000, CRC(0f9c9a12) SHA1(6c593ab037f9e203e50a13bef1cdbba765a45845) )
...
ROM_START( mk2hack03 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hack03.131", 0x00000, 0x80000, CRC(87a755b5) SHA1(d1796dfae89ca1163cb3db3638066d4bd54d32a8) )
	ROM_LOAD16_BYTE( "ug12_hack03.131", 0x00001, 0x80000, CRC(b59368c4) SHA1(987ff2ee0944955289b6b156c375b183819072bd) )
...
ROM_START( mk2hack04 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hack04.131", 0x00000, 0x80000, CRC(82c0ef47) SHA1(ae157efe65a3faf9f638e30858475f0c0c2a5a62) )
	ROM_LOAD16_BYTE( "ug12_hack04.131", 0x00001, 0x80000, CRC(bad41b9f) SHA1(1dc178a5a1fa7e84892f8c2fb1baaad01d5549b6) )
...
ROM_START( mk2hack05 ) //mk2k
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hack05.131", 0x00000, 0x80000, CRC(049aa957) SHA1(5a173938d7786a55fbf78db3df25aa9be8efea9c) )
	ROM_LOAD16_BYTE( "ug12_hack05.131", 0x00001, 0x80000, CRC(6eb2bd15) SHA1(e767ba4e5878a2e139803f2ec9cc60a4baaad556) )
...
// Mortal Kombat
GAME( 2007, mkhack01,   mk,  tunit_adpcm, mk,  midtunit_state, init_mktunit, ROT0, "Arkatrad",      "Mortal Kombat (Translation French)", MACHINE_SUPPORTS_SAVE )
GAME( 2012, mkhack02,   mk,  tunit_adpcm, mk,  midtunit_state, init_mktunit, ROT0, "Zenomorp",      "Mortal Kombat (Projectile Insanity)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, mkhack03,   mk,  tunit_adpcm, mk,  midtunit_state, init_mktunit, ROT0, "TEAM UMK 3",    "Mortal Kombat (Free Play 2018-02-20)", MACHINE_SUPPORTS_SAVE )
// Mortal Kombat II
GAME( 2007, mk2hack01,  mk2, tunit_dcs,   mk2, midtunit_state, init_mk2,     ROT0, "Arkatrad",             "Mortal Kombat II (Translation French)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2020, mk2hack05,  mk2, tunit_dcs,   mk2, midtunit_state, init_mk2,     ROT0, "TEAM UMK 3",           "Mortal Kombat II (Free Play 2020-06-01)", MACHINE_SUPPORTS_SAVE )
