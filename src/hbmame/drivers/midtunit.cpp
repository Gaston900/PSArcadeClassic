...
ROM_START( mkhc01 )
	...
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc01.bin", 0x00000, 0x80000, CRC(2f47f224) SHA1(44c10853696507e0c73eaeb1d5bda095af9ae62f) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc01.bin", 0x00001, 0x80000, CRC(39dd89b7) SHA1(e2cfa470ed07824de2d1d43b7a6e7fb4bb8dacf3) )
...
ROM_START( mkhc02 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc02.bin", 0x00000, 0x80000, CRC(f4a9a289) SHA1(a94b0a5796457c6f2789e9fd5a1cb80fd6dcf22b) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc02.bin", 0x00001, 0x80000, CRC(45bed5a1) SHA1(dba2c21878925afdcaf61520c18ebefd5e9617db) )
...
ROM_START( mkhc03 ) //mkk
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc03.bin", 0x00000, 0x80000, CRC(21c3b8f6) SHA1(e2338a39263d7abe1cdadc082d20be8c53fc270d) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc03.bin", 0x00001, 0x80000, CRC(2f7d7079) SHA1(b2c8ccd829341ab0f4613627286ae405a7188460) )
...
ROM_START( mkhc04 ) //mkplus
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc04.bin", 0x00000, 0x80000, CRC(8edf28c0) SHA1(bc91c95d3bbe9942e6cbfa04b77449f9b7becef5) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc04.bin", 0x00001, 0x80000, CRC(be771d8d) SHA1(9644acd2c9392c3a84586d0ea9a51e96e195bf27) )
	...
	ROM_LOAD32_BYTE( "l1_mortal_kombat_t-unit_ug17_game_rom_hc04.ug17", 0x400000, 0x80000, CRC(44b5de0e) SHA1(6de874ca200102ab7e584b66c32d2b3973e55289) )
	ROM_LOAD32_BYTE( "l1_mortal_kombat_t-unit_uj17_game_rom_hc04.uj17", 0x400001, 0x80000, CRC(c69cd46c) SHA1(6bd20e9b6c17c1fa706210c79cb3da2f82b003b2) )
	ROM_LOAD32_BYTE( "l1_mortal_kombat_t-unit_ug22_game_rom_hc04.ug22", 0x400002, 0x80000, CRC(e742a405) SHA1(cf37eb68464955415ae71d7ffbc8c9dd0fc13f87) )
	ROM_LOAD32_BYTE( "l1_mortal_kombat_t-unit_uj22_game_rom_hc04.uj22", 0x400003, 0x80000, CRC(34110899) SHA1(84139426caf0c89b921ba74638ae8a6564616f9f) )
ROM_END
...
ROM_START( mk2hc02 )
	ROM_REGION16_LE( 0xc00000, "dcs", ROMREGION_ERASEFF )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_ii_sound_rom_u2_hc04.u2", 0x000000, 0x80000, CRC(65d11dd7) SHA1(bb94cca5a35f8f285d32314f8762c3c52ec48f5b) )
	ROM_RELOAD(                                             0x100000, 0x80000 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_ii_sound_rom_u3.u3", 0x200000, 0x80000, CRC(d6d92bf9) SHA1(397351c6b707f2595e36360471015f9fa494e894) )
	ROM_RELOAD(                                             0x300000, 0x80000 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_ii_sound_rom_u4.u4", 0x400000, 0x80000, CRC(eebc8e0f) SHA1(705ab63ff7672a4857d546afda6dca4973cce1ad) )
...
ROM_START( mk2hc03 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hc03.131", 0x00000, 0x80000, CRC(82c0ef47) SHA1(ae157efe65a3faf9f638e30858475f0c0c2a5a62) )
	ROM_LOAD16_BYTE( "ug12_hc03.131", 0x00001, 0x80000, CRC(bad41b9f) SHA1(1dc178a5a1fa7e84892f8c2fb1baaad01d5549b6) )
...
ROM_START( mk2hc05 ) //mk2tek
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "uj12_hc05.l31", 0x00000, 0x80000, CRC(92e2240f) SHA1(3c188e094608a225d8eefe28f114d2b56526b2e2) )
	ROM_LOAD16_BYTE( "ug12_hc05.l31", 0x00001, 0x80000, CRC(9736b899) SHA1(39942b491d736baecae9eb67f91487d0d02ac28e) )
...
/* Midtunit Hack */
GAME( 1992, mkhc01,           mk,               tunit_adpcm,      mk,       midtunit_state, init_mktunit,  ROT0, "hack",       "Mortal Kombat (French Translation)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2020, mkhc03,           mk,               tunit_adpcm,      mk,       midtunit_state, init_mktunit,  ROT0, "hack",       "Mortal Kombat (Revision 5.0 Kaillera Friendly SP3 2020-12-02)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, mkhc04,           mk,               tunit_adpcm,      mk,       midtunit_state, init_mktunit,  ROT0, "hack",       "Mortal Kombat Plus (Build 5.0.0741)", MACHINE_SUPPORTS_SAVE )
