...
ROM_START( mkhc02 ) //mkk
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc02.bin", 0x00000, 0x80000, CRC(f04ded75) SHA1(0ba305c8b63085889e1827e5231ce08b5b1adb6c) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc02.bin", 0x00001, 0x80000, CRC(30fd0268) SHA1(2336e5d8cbaaeb6b08f7c68c32af3d02492f81f8) )
...
ROM_START( mkhc03 )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc03.bin", 0x00000, 0x80000, CRC(f4a9a289) SHA1(a94b0a5796457c6f2789e9fd5a1cb80fd6dcf22b) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc03.bin", 0x00001, 0x80000, CRC(45bed5a1) SHA1(dba2c21878925afdcaf61520c18ebefd5e9617db) )
...
ROM_START( mkhc04 ) //mkk, mkr4
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-uj12_hc04.bin", 0x00000, 0x80000, CRC(21c3b8f6) SHA1(e2338a39263d7abe1cdadc082d20be8c53fc270d) )
	ROM_LOAD16_BYTE( "l1_mortal_kombat_t-ug12_hc04.bin", 0x00001, 0x80000, CRC(2f7d7079) SHA1(b2c8ccd829341ab0f4613627286ae405a7188460) )
