...
// Mr. Do!
GAME( 1998, mrdigdo,  mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Do! (Dig Dug sprites)", MACHINE_SUPPORTS_SAVE )
GAME( 1982, mrdofast, mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Do! (Speedup Hack)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, mrdotest, mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Do! Test Rom (2017-12-07)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, mrpac,    mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Pac! (Set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, mrpacb,   mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Pac! (Set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, newdigdo, mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Dig-Do!", MACHINE_SUPPORTS_SAVE )
GAME( 2001, stickydo, mrdo, mrdo,   mrdo, mrdo_state, empty_init, ROT270, "hack", "Mr. Sticky Do!", MACHINE_SUPPORTS_SAVE )
