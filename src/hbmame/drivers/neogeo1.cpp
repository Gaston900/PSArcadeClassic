...
HACK( 2020, pzlcrz,        pbobblen, neogeo_noslot, neogeo, neogeo_state,        neogeo,    ROT0, "Elrayzeur", "Puzzle Crazy", MACHINE_SUPPORTS_SAVE )
...
//
HACK( 2021, blazstarcm,  blazstar, neogeo_noslot, neogeo, neogeo_state, neogeo,   ROT0, "NeoCvera", "Blazing Star (Stage Select hack)", MACHINE_SUPPORTS_SAVE )
