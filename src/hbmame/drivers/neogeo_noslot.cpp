...
HACK( 2001, vliner54,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   vliner,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.54)", MACHINE_SUPPORTS_SAVE )
HACK( 2001, vliner53,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   vliner,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.53)", MACHINE_SUPPORTS_SAVE )
HACK( 1993, wh2h,       wh2,      neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK",              "World Heroes 2 (ALH-006)", MACHINE_SUPPORTS_SAVE )
HACK( 1995, rbff1k,     rbff1,    neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Real Bout Fatal Fury / Real Bout Garou Densetsu (Korean release)", MACHINE_SUPPORTS_SAVE )
...
HACK( 1991, burningfpb, burningf, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Burning Fight (prototype, newer, V07)", MACHINE_SUPPORTS_SAVE )
HACK( 1999, garouha,    garou,    neogeo_noslot,   neogeo, neogeo_state,   garou,    ROT0, "SNK", "Garou - Mark of the Wolves (NGH-2530)" , MACHINE_SUPPORTS_SAVE ) /* Encrypted Code & GFX */
HACK( 1991, gpilotsp,   gpilots,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Ghost Pilots (prototype)", MACHINE_SUPPORTS_SAVE )
HACK( 2003, pnyaanv,    pnyaa,    neogeo_noslot,   neogeo, neogeo_state,   pnyaa,    ROT0, "Aiky / Taito", "Pochi and Nyaa (Ver 2.02)", MACHINE_SUPPORTS_SAVE ) // this version does not show the web address on the title screen
HACK( 1992, viewpoinp,  viewpoin, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Sammy / Aicom", "Viewpoint (prototype)", MACHINE_SUPPORTS_SAVE )
HACK( 1995, stakwindev, neogeo,   no_watchdog,     neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Stakes Winner (early development board)", MACHINE_SUPPORTS_SAVE | MACHINE_NOT_WORKING | MACHINE_IS_INCOMPLETE )
HACK( 1995, froman2b,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "bootleg", "Idol Mahjong Final Romance 2 (Neo-Geo, bootleg of CD version)", MACHINE_SUPPORTS_SAVE )
...
/* Multi Game Doctor 2 */
HACK( 1993, 3countbd,  3countb,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "3 Count Bout (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, 2020bbd,   2020bb,   neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK / Pallas", "2020 Super Baseball (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, alpham2d,  alpham2,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Alpha Mission II (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, androdund, androdun, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Visco", "Andro Dunos (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, aofd,      aof,      neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Art of Fighting (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, bakatonod, bakatono, neogeo_mj,       neogeo,   neogeo_state, neogeo,   ROT0, "Monolith Corp.", "Bakatonosama Mahjong Manyuki (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, bstarsd,   bstars,   neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Baseball Stars Professional (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, burningfd, burningf, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Burning Fight (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, crswordd,  crsword,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Alpha Denshi Co.", "Crossed Swords (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, cyberlipd, cyberlip, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Cyber-Lip (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, eightmand, eightman, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK / Pallas", "Eight Man (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, fatfury1d, fatfury1, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Fatal Fury (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, fbfrenzyd, fbfrenzy, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Football Frenzy (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, gpilotsd,  gpilots,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Ghost Pilots (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, joyjoyd,   joyjoy,   neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Puzzled (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, kotmd,     kotm,     neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "King of the Monsters (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, lbowlingd, lbowling, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "League Bowling (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, lresortd,  lresort,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Last Resort (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, maglordd,  maglord,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Alpha Denshi Co.", "Magician Lord (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, minasand,  minasan,  neogeo_mj,       neogeo,   neogeo_state, neogeo,   ROT0, "Monolith Corp.", "Minnasanno Okagesamadesu (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, mutnatd,   mutnat,   neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Mutation Nation (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, ncombatd,  ncombat,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Alpha Denshi Co.", "Ninja Combat (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, ncommandd, ncommand, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Alpha Denshi Co", "Ninja Commando (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, ridherod,  ridhero,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Riding Hero (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, roboarmyd, roboarmy, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Robo Army (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, sengokud,  sengoku,  neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Sengoku (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1993, sengoku2d, sengoku2, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Sengoku 2 (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, socbrawld, socbrawl, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Soccer Brawl (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, superspyd, superspy, neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "The Super Spy (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1990, tpgolfd,   tpgolf,   neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "SNK", "Top Player's Golf (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1991, trallyd,   trally,   neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Alpha Denshi Co.", "Thrash Rally (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
HACK( 1992, wh1d,      wh1,      neogeo_noslot,   neogeo,   neogeo_state, neogeo,   ROT0, "Alpha Denshi Co.", "World Heroes (Multi Game Doctor 2)", MACHINE_SUPPORTS_SAVE )
...
HACK( 1996, crswd2bl,          neogeo,   neogeo_noslot, neogeo, neogeo_state,     neogeo,    ROT0, "CD_conv",        "Crossed Swords 2 (CD conversion)", MACHINE_SUPPORTS_SAVE )
...
HACK( 2007, joyjoycd,          joyjoy,   neogeo_noslot, neogeo, neogeo_state,     neogeo,    ROT0, "CD_conv",        "Puzzled (CD conversion)", MACHINE_SUPPORTS_SAVE )
...
HACK( 1994, pbobblencd,        pbobblen, neogeo_noslot, neogeo, neogeo_state,     neogeo,    ROT0, "CD_conv",        "Puzzle Bobble (CD conversion)", MACHINE_SUPPORTS_SAVE )
...
HACK( 2007, sengokucd,         sengoku,  neogeo_noslot, neogeo, neogeo_state,     neogeo,    ROT0, "CD_conv",        "Sengoku (CD conversion)", MACHINE_SUPPORTS_SAVE )
...
HACK( 1996, zintrkcd,          zintrckb, neogeo_noslot, neogeo, neogeo_state,     neogeo,    ROT0, "CD_conv",        "ZinTricK (CD conversion)", MACHINE_SUPPORTS_SAVE )
