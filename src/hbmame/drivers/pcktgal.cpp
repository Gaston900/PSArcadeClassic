...
/* Korean Translation */
GAME( 1987, pckgalgr, pcktgal, pcktgal, pcktgal, pcktgal_state, init_original,  ROT0, "GreekRoms", "Pocket Gal (Greek Translation)", MACHINE_SUPPORTS_SAVE )
GAME( 1987, pcktgalk, pcktgal, pcktgal, pcktgal, pcktgal_state, init_original,  ROT0, "Aneue Bannzai", "Pocket Gal (Korean Translation)", MACHINE_SUPPORTS_SAVE )
