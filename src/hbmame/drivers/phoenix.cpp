...
/* Phoenix HomeBrew */
GAME( 1980, phoenixg, phoenix, phoenix,  phoenixt, phoenix_state, empty_init, ROT90, "GreekRoms", "Phoenix (Greek Translation)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, phoetest, phoenix, phoenix,  phoenixt, phoenix_state, empty_init, ROT90, "Phil Murray", "Phoenix Test Rom (HB)", MACHINE_SUPPORTS_SAVE )
