...
ROM_START( gunbirdhc01 ) //gunbirdkp
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "4_hc01.u46", 0x000000, 0x40000, CRC(8066b6f3) SHA1(6ea07cf1cb058da838524ae7f83f6ed24836848d) )
	ROM_LOAD32_WORD_SWAP( "5_hc01.u39", 0x000002, 0x40000, CRC(0a425ce0) SHA1(9b8a5f825c45b8919e43b83cc47056925bed6499) )
	...
	ROM_LOAD16_WORD_SWAP( "u14_hc01.u14",  0x000000, 0x200000, CRC(e143090a) SHA1(545ba6fdfd9b94efeb798b06ba07e8a5b27f8608) )
	ROM_LOAD16_WORD_SWAP( "u24.bin",   0x200000, 0x200000, CRC(5e3ffc9d) SHA1(c284eb9ef56c8e6261fe11f91a10c5c5a56c9803) )
	ROM_LOAD16_WORD_SWAP( "u15_hc01.u15",  0x400000, 0x200000, CRC(e5f6bfb6) SHA1(87825cb74f139aa9a6affc4b236910968a410de7) )
	ROM_LOAD16_WORD_SWAP( "u25_hc01.u25",  0x600000, 0x100000, CRC(cf571ff8) SHA1(0310bc422fde4ab7c4a760ed6dc0606f10ed009a) )
...
ROM_START( samuraiahc01 ) //sngkacek
	...
	ROM_LOAD32_WORD_SWAP( "2-u126_hc01.bin", 0x000002, 0x040000, CRC(e5a51908) SHA1(05511f039a26064a857c3a503a5819a1472654d3) )

	ROM_REGION( 0x020000, "audiocpu", 0 )
	ROM_LOAD( "3-u58.bin", 0x00000, 0x20000, CRC(310f5c76) SHA1(dbfd1c5a7a514bccd89fc4f7191744cf76bb745d) )

	ROM_REGION( 0x200000, "gfx1", 0 )
	ROM_LOAD16_WORD_SWAP( "u14_hc01.bin",  0x000000, 0x200000, CRC(460c0b15) SHA1(32f4d2dbb3668ab93661633dff8497205c11805b) )

	ROM_REGION( 0x200000, "gfx2", 0 )
	ROM_LOAD16_WORD_SWAP( "u34.bin",   0x000000, 0x100000, CRC(e6a75bd8) SHA1(1aa84ea54584b6c8b2846194b48bf6d2afa67fee) )
	ROM_LOAD16_WORD_SWAP( "u35_hc01.bin",  0x100000, 0x100000, CRC(6eb5b9c6) SHA1(4bd93c1b1a665620b3275790081c018a529b3663) )
...
ROM_START( tengaihc02 ) //tengaik
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "2-u40_hc02.bin", 0x000000, 0x80000, CRC(279f7493) SHA1(bb39c50258fe30e4cc4b3da1f2acc05c362f8ddf) )
	ROM_LOAD32_WORD_SWAP( "3-u41_hc02.bin", 0x000002, 0x80000, CRC(59fe486e) SHA1(a6dfbe2e19926c9c1491a5aba480018732c57293) )
	...
	ROM_REGION( 0x600000, "gfx1", 0 )
	ROM_LOAD( "u20_hc02.bin",   0x000000, 0x200000, CRC(934a787a) SHA1(3c5144a01337c206aa452e698c5be7369468d587) )
	ROM_LOAD( "u22.bin",  0x200000, 0x200000, CRC(8d21caee) SHA1(2a68af8b2be2158dcb152c434e91a75871478d41) )
	ROM_LOAD( "u21_hc02.bin",   0x400000, 0x200000, CRC(435669ca) SHA1(4eaf8531e750d5d4bea6b3f4eaa39f7267fe7206) )

	ROM_REGION( 0x400000, "gfx2", 0 )
	ROM_LOAD( "u34_hc02.bin",   0x000000, 0x400000, CRC(801fc802) SHA1(023c2d6515a91188791d923046365d6453c62808) )
...
/* Psikyo Hack */
GAME( 1994, gunbirdhc01,   gunbird,  gunbird,  gunbirdj, psikyo_state, init_gunbird,  ROT270, "hack",       "Gunbird (Korean Translation)", MACHINE_SUPPORTS_SAVE )
GAME( 2024, gunbirdhc02,   gunbird,  gunbird,  gunbird,  psikyo_state, init_gunbird,  ROT270, "GOTVG",      "Gunbird (Ten-Roh 2024-01-05)", MACHINE_SUPPORTS_SAVE | MACHINE_IMPERFECT_TIMING )
GAME( 2024, s1945hc01,     s1945,    s1945,    s1945,    psikyo_state, init_s1945,    ROT270, "GOTVG",      "Strikers 1945 (Ten-Dream 2024-01-09)", MACHINE_SUPPORTS_SAVE | MACHINE_IMPERFECT_TIMING )
GAME( 1993, samuraiahc01,  samuraia, sngkace,  sngkace,  psikyo_state, init_sngkace,  ROT270, "hack",       "Sengoku Ace (Korean Translation)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, tengaihc01,    tengai,   s1945,    tengai,   psikyo_state, init_tengai,   ROT0,   "hack",       "Tengai (Infinite Power 2009-10-31)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, tengaihc02,    tengai,   s1945,    tengaij,  psikyo_state, init_tengai,   ROT0,   "hack",       "Tengai (Korean Translation)", MACHINE_SUPPORTS_SAVE )
GAME( 2024, tengaihc03,    tengai,   s1945,    tengaij,  psikyo_state, init_tengai,   ROT0,   "GOTVG",      "Tengai (Ten-Roh 2024-01-08)", MACHINE_SUPPORTS_SAVE )
