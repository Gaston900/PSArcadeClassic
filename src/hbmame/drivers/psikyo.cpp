...
ROM_START( tengaihack01 )  // hack of tengai
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "5-u40_hack01.bin", 0x000000, 0x080000, CRC(aae15ef1) SHA1(e5d056eb0ef26a697544cbeacb5f993217fdbd0a) )
    ROM_LOAD32_WORD_SWAP( "4-u41_hack01.bin", 0x000002, 0x080000, CRC(e8863874) SHA1(f6ac25170516658c368fb86b2b653e3356b42f19) )
...
// Tengai
GAME( 2009, tengaihack01,    tengai,   s1945,    tengai,   psikyo_state, init_tengai,   ROT0,   "pipi899",  "Tengai (Ex Super Version 2009-10-31)", MACHINE_SUPPORTS_SAVE )
