...
ROM_START( rabbithc01 )
	...
	ROM_LOAD32_BYTE( "jpr0_hc01.0", 0x000000, 0x080000, CRC(3be967ee) SHA1(3d048dd674516b79cd0d2d6f2bc88e0c93ee6ee8) )
	ROM_LOAD32_BYTE( "jpr1_hc01.1", 0x000001, 0x080000, CRC(56e1f900) SHA1(15b0c249cf5f3b127a12eaa44ab61a19170c3f08) )
	ROM_LOAD32_BYTE( "jpr2_hc01.2", 0x000002, 0x080000, CRC(e01d4b54) SHA1(a55e1e960e614ec8fac05dff58b184612bb0faad) )
	ROM_LOAD32_BYTE( "jpr3_hc01.3", 0x000003, 0x080000, CRC(bb176c24) SHA1(4185769bb519dbaf53b6997851367883339dbfbc) )
...
ROM_START( rabbithc02 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE( "jpr0_hc02.0", 0x000000, 0x080000, CRC(a838827e) SHA1(2c6135c4a01b402ccd71586c5422dfc07fbb882d) )
	ROM_LOAD32_BYTE( "jpr1_hc02.1", 0x000001, 0x080000, CRC(e49cb55c) SHA1(cf5ce5a51b5cc32b7962c0484bef9f5746343157) )
	ROM_LOAD32_BYTE( "jpr2_hc02.2", 0x000002, 0x080000, CRC(ae05dee8) SHA1(da83bb58f4f3b9ed0da06ddea62be7abca9b3281) )
...
ROM_START( rabbithc03 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE( "jpr0_hc03.0", 0x000000, 0x080000, CRC(dff67a87) SHA1(d60332ce38a5edc89b636c89cfed30d9ab6e2e91) )
	ROM_LOAD32_BYTE( "jpr1_hc03.1", 0x000001, 0x080000, CRC(ec8821a8) SHA1(82c1886ad08a871cc990c7d5be4fb4da11b82615) )
	ROM_LOAD32_BYTE( "jpr2_hc03.2", 0x000002, 0x080000, CRC(bf758d7d) SHA1(46036bbc7f8d5a9c7fa51e9c3b296a786e086e50) )
	ROM_LOAD32_BYTE( "jpr3_hc03.3", 0x000003, 0x080000, CRC(88a82b5e) SHA1(afc6d99e16eaf4b1eba7d1aeebffb4b6575b4900) )
...
// Hack/Homebrow
GAME( 1997, rabbithc01,   rabbit, rabbit,  rabbit, rabbit_state, empty_init, ROT0,    "hack",      "Rabbit (Enable Hidden Character)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
GAME( 1997, rabbithc02,   rabbit, rabbit,  rabbit, rabbit_state, empty_init, ROT0,    "hack",      "Rabbit (Easy Move)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
GAME( 2018, rabbithc03,   rabbit, rabbit,  rabbit, rabbit_state, empty_init, ROT0,    "hack",      "Rabbit (Ex Super Version 2018-03-04)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
