...
/* Rabbit Hack */
GAME( 1997, rabbithc01,   rabbit, rabbit,  rabbit, rabbit_state, empty_init, ROT0,    "hack",      "Rabbit (Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
GAME( 1997, rabbithc02,   rabbit, rabbit,  rabbit, rabbit_state, empty_init, ROT0,    "DDJ",       "Rabbit (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
