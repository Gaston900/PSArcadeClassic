...
// Hack/Homebrow
GAME( 1997, rabbithc01,   rabbit, rabbit,  rabbit, rabbit_state, init_rabbit, ROT0,    "DDJ",       "Rabbit (Enable Hidden Character)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
GAME( 1997, rabbithc02,   rabbit, rabbit,  rabbit, rabbit_state, init_rabbit, ROT0,    "DDJ",       "Rabbit (Easy Move)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
GAME( 2018, rabbithc03,   rabbit, rabbit,  rabbit, rabbit_state, init_rabbit, ROT0,    "hack",      "Rabbit (Ex Super Version 2018-03-04)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
