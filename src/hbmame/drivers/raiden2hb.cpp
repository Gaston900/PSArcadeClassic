...
ROM_START( zeroteamhc01 ) //zeroteamdw
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE("b1.u024_hc01.5k",   0x000000, 0x40000, CRC(b47b73b7) SHA1(1ed53b517c7886383772f731fed95b2e8e7b523e) )
	ROM_LOAD32_BYTE("b3.u023_hc01.6k",   0x000002, 0x40000, CRC(81979a9b) SHA1(1b9e216f9f6b4e6d38ac881dfe0e7ee53c523f1b) )
	ROM_LOAD32_BYTE("b2.u025_hc01.6l",   0x000001, 0x40000, CRC(7513250c) SHA1(f7aee5c2facfc663a2864497dc213e944b9e3b7b) )
	ROM_LOAD32_BYTE("b4.u026_hc01.5l",   0x000003, 0x40000, CRC(10341ede) SHA1(b63351b606d2ed59db721b2ab1765a9504c1018b) )
...
ROM_START( zeroteamhc02 ) //zeroteams, zeroteam1v4
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE("1_sel_hc02.bin",   0x000000, 0x40000, CRC(c2f5bba6) SHA1(a99655bef65af96c160c5e83b709597edff2a953) )
	ROM_LOAD32_BYTE("3_sel_hc02.bin",   0x000002, 0x40000, CRC(aa278057) SHA1(dfe1082c1555b196989f3cbbd2b6207947f5059a) )
	ROM_LOAD32_BYTE("seibu__2.u025.6l",   0x000001, 0x40000, CRC(54f3d359) SHA1(869744185746d55c60d2f48eabe384a8499e00fd) )
	ROM_LOAD32_BYTE("4_sel_hc02.bin",   0x000003, 0x40000, CRC(ae82d427) SHA1(1bc5f52791c1508e59d3b2aef04d239657defc20) )
...
ROM_START( zeroteamhc03 ) //zeroteamb
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_BYTE("1_sel_hc03.bin",   0x000000, 0x40000, CRC(c1c66888) SHA1(eb746efd7fea9a258d34c85cc8a739e029ba54d6) )
	ROM_LOAD32_BYTE("3_sel_hc03.bin",   0x000002, 0x40000, CRC(f5c02ca4) SHA1(2d0e561b51db5f358f75b0990dc2b4cd43ee8424) )
	ROM_LOAD32_BYTE("2_sel_hc03.bin",   0x000001, 0x40000, CRC(8ff58607) SHA1(bfb811ce3d3b645f23a17e36d6277440e2ff454f) )
	ROM_LOAD32_BYTE("4_sel_hc03.bin",   0x000003, 0x40000, CRC(58d7c48e) SHA1(8ae055bb869e6a4fb789a0419d3c6ac45a24a312) )
...
// Hack/Homebrow
GAME( 1993, zeroteamhc01,  zeroteam, zeroteam, zeroteam, raiden2_state, init_zeroteam,  ROT0,   "hack",       "Zero Team Selection (Special Attack)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, zeroteamhc02,  zeroteam, zeroteam, zeroteam, raiden2_state, init_zeroteam,  ROT0,   "hack",       "Zero Team Selection (1v4 Version 2018-02-19)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, zeroteamhc03,  zeroteam, zeroteam, zeroteam, raiden2_state, init_zeroteam,  ROT0,   "hack",       "Zero Team Selection (Nightmare 2018-10-22)", MACHINE_SUPPORTS_SAVE )
