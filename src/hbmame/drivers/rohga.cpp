...
ROM_START( schmeisrhc01 ) //Description: Press 'Start' to select Celberus
	ROM_REGION(0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "sr001j_hc01.8a",  0x000000, 0x80000, CRC(a61407c2) SHA1(64a90c95a3fba9d01cfcb55cd562861cdeaa8f7a) )
	ROM_LOAD16_BYTE( "sr006j_hc01.8d",  0x000001, 0x80000, CRC(64afec76) SHA1(8b9bdb2a3db438b710bcd58980ee0411c0e1ea0a) )
...
/* Rohga Hack */
GAME( 1993, schmeisrhc01, schmeisr,  schmeisr, schmeisr, rohga_state, init_schmeisr, ROT0,   "hack",   "Schmeiser Robo (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
