...
ROM_START( outrunhc01 ) //outrunm
	ROM_REGION( 0x60000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "epr-10380b_hc01.133", 0x00000, 0x10000, CRC(9bf1d4df) SHA1(4d4be736c25f0e2f60851d26150ed6807014466a) ) // new
	ROM_LOAD16_BYTE( "epr-10382b_hc01.118", 0x00001, 0x10000, CRC(86f90666) SHA1(e6a40afdbd5390266e9b43073cb41ec38b01d67c) ) // new
	ROM_LOAD16_BYTE( "epr-10381b_hc01.132", 0x20000, 0x10000, CRC(cbec3f7e) SHA1(094d23afccf52bd25ae9ae9fdb9087cf3ac41709) ) // new
	ROM_LOAD16_BYTE( "epr-10383b_hc01.117", 0x20001, 0x10000, CRC(e3c5cdca) SHA1(629dac90615deb2f68368012d5c67442b93c39b3) ) // new
	...
	ROM_LOAD( "epr-10187_hc01.88", 0x00000, 0x20000, CRC(9f89439e) SHA1(a7c7610327e91647b41d73635a87ef2b95eee698) ) // new
...
/* Segaorun Hack */
GAMEL(2016, outrunhc01,   outrun,   outrunm, outrun, outrunm_state,  init_init,     ROT0,   "Cmonkey",           "Out Run (sitdown/upright, Rev B) (Added Music)", MACHINE_SUPPORTS_SAVE, layout_outrun ) // March? 2016
GAME( 2017, outrunt1,     outrun,   outrun,  outrun, segaorun_state, init_outrun,   ROT0,   "Alex Bartholomeus", "Out Run (Memory Test v0.1) (HB)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, toutrundt1,   toutrun,  outrun,  toutrun,segaorun_state, init_outrun,   ROT0,   "Alex Bartholomeus", "Turbo Out Run (Ram Test v0.1) (HB)", MACHINE_SUPPORTS_SAVE )
