...
ROM_START( msgundamhc01 )
	ROM_REGION( 0x200000, "maincpu", 0 )  
	ROM_LOAD16_WORD_SWAP( "fa003002_hc01.u25",  0x000000, 0x080000, CRC(b06cc71a) SHA1(b5de10639458a569fe4789e3595fa4acd645dbf4) )
...
/* Seta Hack */
GAME( 1992, blandiahc01,   blandia,   blandia,   blandia,   seta_state,     init_bankx1,    ROT0,   "DDJ",       "Blandia (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, blandiahc02,   blandia,   blandia,   blandia,   seta_state,     init_bankx1,    ROT0,   "hack",      "Blandia (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, msgundamhc01,  msgundam,  msgundam,  msgundam,  seta_state,     empty_init,     ROT0,   "DDJ",       "Mobile Suit Gundam (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
