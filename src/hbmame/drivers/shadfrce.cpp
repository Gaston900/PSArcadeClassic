...
ROM_START( shadfrcehack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "32a12-011_hack01.34", 0x00001, 0x40000, CRC(6b9afcd6) SHA1(2d87e3cbb430762df0782416871af363158938b2) ) 
	ROM_LOAD16_BYTE( "32a13-010_hack01.26", 0x00000, 0x40000, CRC(52d1861a) SHA1(2d9a37c3cfaa0ed382c738f5ddb289dd1b37bc64) )
...
// Shadow Force
GAME( 1993, shadfrcehack01,   shadfrce,  shadfrce, shadfrce, shadfrce_state, empty_init, ROT0, "KrysoFun", "Shadow Force (Enable All Characters)", MACHINE_NOT_WORKING | MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
