...
ROM_START( silkroadhack01 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "rom02_hack01.bin", 0x000000, 0x100000, CRC(a4fea2c0) SHA1(0acd17bce5f62ff374dfa07ecdaed851d71e58bf) )
	ROM_LOAD32_WORD_SWAP( "rom03_hack01.bin", 0x000002, 0x100000, CRC(a4318e7b) SHA1(01dc82bdc421031c13c2b08b8c79457c5d1d644c) )
...
ROM_START( silkroadhack02 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "rom02_hack02.bin", 0x000000, 0x100000, CRC(d8159448) SHA1(002cf208e57ae9ab9a4b4f7081ec139d61b28d06) )
	ROM_LOAD32_WORD_SWAP( "rom03_hack02.bin", 0x000002, 0x100000, CRC(fb215953) SHA1(435708ebc8027002bf2864c357760f599e611554) )
...
ROM_START( silkroadhack03 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "rom02_hack03.bin", 0x000000, 0x100000, CRC(32b93674) SHA1(eaa1dd00b561b32e0897c55c760318a8ddc75164) )
	ROM_LOAD32_WORD_SWAP( "rom03_hack03.bin", 0x000002, 0x100000, CRC(2cdc10a4) SHA1(7b902487073265ed55a68758d8f01e4b78b1b8dd) )
...
// The Legend of Silkroad
GAME( 1999, silkroadhack01,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0, "DDJ",  "The Legend of Silkroad (All Move Without Magic)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, silkroadhack02,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0, "DDJ",  "The Legend of Silkroad (Easy Move)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, silkroadhack03,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0, "hack", "The Legend of Silkroad (Simple Attack 2018-03-18)", MACHINE_SUPPORTS_SAVE )
