...
ROM_START( silkroadhc01 )
	...
	ROM_LOAD32_WORD_SWAP( "rom02_hc01.bin", 0x000000, 0x100000, CRC(a4fea2c0) SHA1(0acd17bce5f62ff374dfa07ecdaed851d71e58bf) )
	ROM_LOAD32_WORD_SWAP( "rom03_hc01.bin", 0x000002, 0x100000, CRC(a4318e7b) SHA1(01dc82bdc421031c13c2b08b8c79457c5d1d644c) )
...
ROM_START( silkroadhc02 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "rom02_hc02.bin", 0x000000, 0x100000, CRC(d8159448) SHA1(002cf208e57ae9ab9a4b4f7081ec139d61b28d06) )
	ROM_LOAD32_WORD_SWAP( "rom03_hc02.bin", 0x000002, 0x100000, CRC(fb215953) SHA1(435708ebc8027002bf2864c357760f599e611554) )
...
ROM_START( silkroadhc03 ) //silkroada
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "rom02_hc03.bin", 0x000000, 0x100000, CRC(c53421b0) SHA1(20125655f3fcfe95b2b4614401cc818ec8a7ca90) )
	ROM_LOAD32_WORD_SWAP( "rom03_hc03.bin", 0x000002, 0x100000, CRC(37d639ec) SHA1(6ae2b4fb2741176894049eff6773bfa37a797969) )
...
/* Silkroad Hack */
GAME( 1999, silkroadhc01,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0,  "DDJ",       "The Legend of Silkroad (All Move Without Magic)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, silkroadhc02,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0,  "DDJ",       "The Legend of Silkroad (Easy Special Attacks)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, silkroadhc03,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0,  "GOTVG",     "The Legend of Silkroad (1V2 2020-12-07)", MACHINE_SUPPORTS_SAVE )
