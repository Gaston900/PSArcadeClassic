...
ROM_START( silkroadhc03 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD32_WORD_SWAP( "rom02_hc03.bin", 0x000000, 0x100000, CRC(32b93674) SHA1(eaa1dd00b561b32e0897c55c760318a8ddc75164) )
	ROM_LOAD32_WORD_SWAP( "rom03_hc03.bin", 0x000002, 0x100000, CRC(2cdc10a4) SHA1(7b902487073265ed55a68758d8f01e4b78b1b8dd) )
...
GAME( 1999, silkroadhc02,  silkroad,   silkroad, silkroad, silkroad_state, empty_init,   ROT0,    "DDJ",        "The Legend of Silkroad (Easy Move)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, silkroadhc03,  silkroad,   silkroad, silkroad, silkroad_state, empty_init,   ROT0,    "hack",       "The Legend of Silkroad (Simple Attack 2018-03-18)", MACHINE_SUPPORTS_SAVE )
