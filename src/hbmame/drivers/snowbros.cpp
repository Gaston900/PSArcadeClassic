...
ROM_START( snowbroshack01 ) //snowbrosa
...
// Snow Bros. - Nick & Tom
GAME( 2018, snowbroshack01,   snowbros,  snowbros,    snowbros, snowbros_state, empty_init, ROT0, "EMU_MAX",  "Snow Bros (Cure Version 2.6B 2018-08-15)", MACHINE_SUPPORTS_SAVE )
