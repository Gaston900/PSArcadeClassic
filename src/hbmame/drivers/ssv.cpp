...
ROM_START( survartshack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )  
	ROM_LOAD16_BYTE( "prl-r6_hach01.u4", 0x000000, 0x080000, CRC(9daf2473) SHA1(f2375ba98f84373c00109e55841dab2c582d0ba6) )
	ROM_LOAD16_BYTE( "prh-r5_hach01.u3", 0x000001, 0x080000, CRC(5d0d1f56) SHA1(a46a8eaf07db5200219b954ffc954759328cbadb) )
...
// Survival Arts
GAME( 1993,  survartshack01,  survarts,  survarts, survarts, ssv_state, init_ssv, ROT0,   "DDJ",  "Survival Arts (Easy Move)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
