...
ROM_START( wbmlhc01 ) //wbmlbit
	...
	ROM_LOAD( "wbml_hc01.02", 0x30000, 0x8000, CRC(680f2186) SHA1(bb7b43a8d8438ec9dc55f219db284934a57ea81a) )
	...
	ROM_LOAD( "wbml_hc01.08",    0x00000, 0x8000, CRC(bc2846d3) SHA1(6777ef6ca5b92600aa6038d773cdd8263639b1cb) )
	ROM_LOAD( "wbml_hc01.09",    0x08000, 0x8000, CRC(c61fd58e) SHA1(f17dba3195e8b3c3d443d696cce63604cdc64a5e) )
	ROM_LOAD( "wbml_hc01.10",    0x10000, 0x8000, CRC(e0386c02) SHA1(bdfa5fa2bbf641730865d74057203e41dcae80fa) )
...
ROM_START( wbmlhc02 ) //wbmlkb
	ROM_REGION( 0x40000, "maincpu", 0 )
	ROM_LOAD( "wbml.01",      0x20000, 0x8000, CRC(66482638) SHA1(887f93015f0effa2d0fa1f1f59082f75ac072221) )
	ROM_CONTINUE(             0x00000, 0x8000 )
	ROM_LOAD( "wbml_hc02.02", 0x30000, 0x8000, CRC(7dd0b45a) SHA1(ae715437c225013bade54cf021be708c5145a84f) )
	ROM_CONTINUE(             0x10000, 0x8000 )
	ROM_LOAD( "wbml_hc02.03", 0x38000, 0x8000, CRC(11881703) SHA1(b5e4d477158e7653b0fef5a4806be7b4871e917d) )
	ROM_CONTINUE(             0x18000, 0x8000 )
	...
	ROM_REGION( 0x18000, "tiles", 0 )
	ROM_LOAD( "wbml_hc02.08",  0x00000, 0x8000, CRC(7e631c73) SHA1(ef7bc9c8b15083680f8169fa8d322cfbfa7d54ac) )
	ROM_LOAD( "wbml_hc02.09",  0x08000, 0x8000, CRC(4c67a9a6) SHA1(eac1f97aac3f5b0ce96dd082c7741033caa4b55b) )
	ROM_LOAD( "wbml_hc02.10",  0x10000, 0x8000, CRC(0440b0c7) SHA1(f0e321dc6c979807852c375c8a6905fd32336dde) )
...
/* System1 Hack */
GAME( 1987, wbmlhc01,  wbml,  sys2xb,  wbml, system1_state, init_bootsys2, ROT0, "hack",       "Wonder Boy in Monster Land (Italian Translation)", MACHINE_SUPPORTS_SAVE )
GAME( 1987, wbmlhc02,  wbml,  sys2xb,  wbml, system1_state, init_bootsys2, ROT0, "hack",       "Wonder Boy in Monster Land (Korean Translation)", MACHINE_SUPPORTS_SAVE )
