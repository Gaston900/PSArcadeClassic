...
ROM_START( taotaidohack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "tt0-u90.bin", 0x00000, 0x80000, CRC(69d4cca7) SHA1(f1aba74fef8fe4271d19763f428fc0e2674d08b3) )
	ROM_LOAD16_WORD_SWAP( "tt1-u91_hack01.bin", 0x80000, 0x80000, CRC(37eb4426) SHA1(af40965065f8e96f384fb3f3b669e78d511a05ca) )
...
//Tao Taido
GAME( 1993, taotaidohack01, taotaido, taotaido, taotaido6, taotaido_state, empty_init, ROT0, "DDJ", "Tao Taido (Easy Move)",   MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
