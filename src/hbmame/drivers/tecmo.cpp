...
ROM_START( geminihack01 )
	ROM_REGION( 0x20000, "maincpu", 0 )
	ROM_LOAD( "gw04-5s_hack01.rom",  0x00000, 0x10000, CRC(b73a2776) SHA1(20d8f203207f372f80f169b6e3a54a99967a93dc) ) 
	...
	ROM_LOAD( "gw02-3h_hack01.rom",  0x00000, 0x08000, CRC(3ddd13f3) SHA1(b7b1f3b0c1b457fa7744f6fedb694cdd855372c9) )
...
ROM_START( geminihack02 ) // same as gemini except for 1c
	ROM_REGION( 0x20000, "maincpu", 0 )
	...
	ROM_REGION( 0x40000, "gfx2", 0 )
	ROM_LOAD( "gw06-1c_hack01.rom",   0x00000, 0x10000, CRC(c47b1c97) SHA1(7d8680afe4bc76ac712ef2e86bb43bbe02c77199) )
	ROM_LOAD( "gw07-1d.rom",   0x10000, 0x10000, CRC(da42637e) SHA1(9885c52823279f26871092c77bdbe027df08268f) )
	ROM_LOAD( "gw08-1f.rom",   0x20000, 0x10000, CRC(0b4e8d70) SHA1(55069f3df1c8db83f306d46b8262fd23585e6013) )
	ROM_LOAD( "gw09-1h.rom",   0x30000, 0x10000, CRC(b65c5e4c) SHA1(699e1a9e72b8d94edae7382ba119fe5da113514d) )
...
ROM_START( rygarhack01 )
	ROM_REGION( 0x20000, "maincpu", 0 )
	
	ROM_LOAD( "cpuj_5p_hack01.bin",  0x00000, 0x08000, CRC(0262b88b) SHA1(42135f50c2c416b749a364632ab174703a3781c3) )
	ROM_LOAD( "cpuj_5m.bin",  0x08000, 0x04000, CRC(3f180979) SHA1(c4c2e9f83b06b8677978800bfcc39f4ba3b344ab) ) 
	ROM_LOAD( "cpuj_5j_hack01.bin",  0x10000, 0x08000, CRC(21eb55c0) SHA1(83ec2103ea3ce6d400f2f91d93d5f6f8bdb09e9e) ) 

	ROM_REGION( 0x10000, "soundcpu", 0 )
	ROM_LOAD( "cpu_4h.bin",   0x0000, 0x2000, CRC(e4a2fa87) SHA1(ed58187dbbcf59358496a98ffd6c227a87d6c433) )

	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "cpuj_8k_hack01.bin",  0x00000, 0x08000, CRC(c020cfd3) SHA1(8e0d6cfad07e44d6e08dd4fda160497dd8667f42) ) 
...
ROM_START( rygarhack02 ) // same as rygarj except for gfx1
	ROM_REGION( 0x20000, "maincpu", 0 )
	...
	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "cpu_8k_hack01.bin",    0x00000, 0x08000, CRC(370bd8c0) SHA1(a4f140c8890608afdee4617ad1165b491cd103d8) )
...
ROM_START( silkwormhack01 )
	ROM_REGION( 0x20000, "maincpu", 0 )
	ROM_LOAD( "silkworm_hack01.4",   0x00000, 0x10000, CRC(73f3eb16) SHA1(89ec812f9b1d201e4c9c9774e8e8be1848eba334) ) 
	...
	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "silkworm_hack01.2",   0x00000, 0x08000, CRC(dd312a50) SHA1(fe398f4e0991c5c1f746851f224dcad6b8a667df) )
...
// Gemini Wing 
GAME( 1987, geminihack01,    gemini,   gemini,   gemini,   tecmo_state, init_gemini,   ROT90, "hack",   "Gemini Wing (Translation Chinese)",          MACHINE_SUPPORTS_SAVE )
GAME( 2002, geminihack02,    gemini,   gemini,   gemini,   tecmo_state, init_gemini,   ROT90, "Twisty", "Gemini Wing (Sprite Donkey kong)", MACHINE_SUPPORTS_SAVE )
// Argus no Senshi
GAME( 1986, rygarhack01,     rygar,    rygar,    rygar,    tecmo_state, init_rygar,    ROT0,  "hack",   "Argus no Senshi (Translation Chinese)",      MACHINE_SUPPORTS_SAVE )
GAME( 1986, rygarhack02,     rygar,    rygar,    rygar,    tecmo_state, init_rygar,    ROT0,  "hack",   "Argus no Senshi (Translation Korean)", MACHINE_SUPPORTS_SAVE )
// Silk Worm
GAME( 1988, silkwormhack01,  silkworm, silkworm, silkworm, tecmo_state, init_silkworm, ROT0,  "hack",   "Silk Worm (Translation Chinese)",            MACHINE_SUPPORTS_SAVE )
