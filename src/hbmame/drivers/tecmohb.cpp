...
ROM_START( geminihc01 )
	...
	ROM_LOAD( "gw04-5s_hc01.rom",  0x00000, 0x10000, CRC(b73a2776) SHA1(20d8f203207f372f80f169b6e3a54a99967a93dc) ) 
...
ROM_START( rygarhc01 )
	...
	ROM_LOAD( "cpuj_5j_hc01.bin",  0x10000, 0x08000, CRC(21eb55c0) SHA1(83ec2103ea3ce6d400f2f91d93d5f6f8bdb09e9e) ) 

	ROM_REGION( 0x10000, "soundcpu", 0 )
	ROM_LOAD( "cpu_4h.bin",   0x0000, 0x2000, CRC(e4a2fa87) SHA1(ed58187dbbcf59358496a98ffd6c227a87d6c433) )

	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "cpuj_8k_hc01.bin",  0x00000, 0x08000, CRC(c020cfd3) SHA1(8e0d6cfad07e44d6e08dd4fda160497dd8667f42) ) 
...
ROM_START( rygarhc02 ) // same as rygarj except for gfx1
	ROM_REGION( 0x20000, "maincpu", 0 )
	...
	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "cpu_8k_hc01.bin",    0x00000, 0x08000, CRC(370bd8c0) SHA1(a4f140c8890608afdee4617ad1165b491cd103d8) )
...
ROM_START( silkwormhc01 )
	ROM_REGION( 0x20000, "maincpu", 0 )
	ROM_LOAD( "silkworm_hc01.4",   0x00000, 0x10000, CRC(73f3eb16) SHA1(89ec812f9b1d201e4c9c9774e8e8be1848eba334) ) 
	...
	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "silkworm_hc01.2",   0x00000, 0x08000, CRC(dd312a50) SHA1(fe398f4e0991c5c1f746851f224dcad6b8a667df) )
...
GAME( 1986, rygarhc02,     rygar,    rygar,    rygar,    tecmo_state, init_rygar,    ROT0,    "hack",       "Argus no Senshi (Translation Korean)", MACHINE_SUPPORTS_SAVE )
