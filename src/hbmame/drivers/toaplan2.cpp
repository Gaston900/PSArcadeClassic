...
#include "../mame/drivers/toaplan2.cpp"
 ...
 /*********************
 Batsugun Transparent
************************/

ROM_START( batsugunhack01 )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "tp030_01_hack01.bin", 0x000000, 0x080000, CRC(63d28fd3) SHA1(aa3e111d596f408b735e4f79ab654eea24bd6f0c) )
...
ROM_START( bgareggahack01 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "prg0_hack01.bin", 0x000000, 0x080000, CRC(6f4af466) SHA1(fb77f3b86c0b25941ae0efe70ca779d06f66f02b) )
	ROM_LOAD16_BYTE( "prg1_hack01.bin", 0x000001, 0x080000, CRC(b4dc9a48) SHA1(9310a8c1de2a64e5597206a9974f25351d7825c2) )
...
ROM_START( mahoudaihack01 )
	...
	ROM_LOAD( "ra-ma01-rom2_hack01.u2",  0x000000, 0x100000, CRC(865bd232) SHA1(5e8f26b16356c314e244e939ebe696598c1e260d) )
	ROM_LOAD( "ra-ma01-rom3_hack01.u1",  0x100000, 0x100000, CRC(Be068595) SHA1(3e0f9179fce5d9337c18021debe3954157657568) )

	ROM_REGION( 0x008000, "text", 0 )
	ROM_LOAD( "ra_ma_01_05h_hack01.u81",  0x000000, 0x008000, CRC(95d5d1dc) SHA1(a42cabb68443fe71702e552754ed0326480e7c98) )
...
ROM_START( shippumdhack01 )
	...
	ROM_REGION( 0x008000, "text", 0 )
	ROM_LOAD( "ma02rom5_hack01.bin",  0x000000, 0x008000, CRC(116ae559) SHA1(99b25c4ee9bbed8f23c5b5bf4a0a34ff8773c273) )
...
ROM_START( snowbro2hack01 )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "pro-4_hack01", 0x000000, 0x080000, CRC(1ad75ae7) SHA1(4c9d7480df4b94aaee5616939547456a0c560f19) )
...
ROM_START( truxton2hack01 )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD16_WORD( "tp024_1_hack01.bin", 0x000000, 0x080000, CRC(599ed4e3) SHA1(43176fbd6440fe7baa00c02a763b641ea2581a4e) )
...
// Batsugun Transparent
GAME( 1993, batsugunhack01,  batsugun, batsugun, batsugun,   toaplan2_state, init_dogyuun,  ROT270, "Eezezy",       "Batsugun Transparent (Crazy Gun Transparent Version 2015-03-22)", MACHINE_SUPPORTS_SAVE )
// Battle Garegga
GAME( 1996, bgareggahack01,  bgaregga, bgaregga, bgaregga,   toaplan2_state, init_bgaregga, ROT270, "Zack",         "Battle Garegga (Zakk version)", MACHINE_SUPPORTS_SAVE )
// Kingdom Grand Prix
...
// Mahou Daisakusen 
GAME( 1993, mahoudaihack01,  sstriker, mahoudai, mahoudai,   toaplan2_state, empty_init,    ROT270, "liujunusa",    "Mahou Daisakusen (Translation Chinese)", MACHINE_SUPPORTS_SAVE )
// Shippu Mahou Daisakusen
GAME( 1994, shippumdhack01,  kingdmgp, shippumd, shippumd,   toaplan2_state, empty_init,    ROT270, "NeilCorlett",  "Shippu Mahou Daisakusen (Translation English)", MACHINE_SUPPORTS_SAVE )
// Snow Bros 2
GAME( 1994, snowbro2hack01,  snowbro2, snowbro2, snowbro2,   toaplan2_state, empty_init,    ROT0,   "RockyWall",    "Snow Bros 2 (Ex Super Version)", MACHINE_SUPPORTS_SAVE )
// Truxton II / Tatsujin Oh
GAME( 2021, truxton2hack01,  truxton2, truxton2, truxton2,   toaplan2_state, empty_init,    ROT270, "mycophobia",   "Truxton II / Tatsujin Oh (New Version)",  MACHINE_SUPPORTS_SAVE )
