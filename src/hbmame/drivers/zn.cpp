...
ROM_START( doapphack01 )
	TPS_BIOS
	ROM_REGION32_LE( 0x02800000, "bankedroms", 0 )
	ROM_LOAD16_BYTE( "doapp119_hack01.bin", 0x0000001, 0x100000, CRC(f3691595) SHA1(470ea8989229b6400cb7adac30939a2f635dccd9) )
	ROM_LOAD16_BYTE( "doapp120_hack01.bin", 0x0000000, 0x100000, CRC(3a8e9786) SHA1(8632bcba3ecd42c112885821792c78f7b0f51cd9) )
...
ROM_START( sfexhack01 )
	...
	ROM_LOAD( "sfe-05m_hack01.3h", 0x0000000, 0x400000, CRC(ee9ab584) SHA1(82c31637d58fabf41a29bc55f2c23e97a13c6520) )
...
ROM_START( sfex2hack01 )
	...
	ROM_LOAD( "ex2-05m_hack01.3h", 0x0000000, 0x800000, CRC(b78cdfd2) SHA1(64b53a777af2c943b023011afe1919aba452a6d1) )
...
ROM_START( sfex2phack01 )
	CPZN2_BIOS
	ROM_REGION32_LE( 0x80000, "countryrom", 0 )
	ROM_LOAD( "x2pu_04.2h", 0x0000000, 0x080000, CRC(2938118c) SHA1(4bdeeb9aa3dd54ef44aa3fc73d78d65297b1ed25) )

	ROM_REGION32_LE( 0x3000000, "bankedroms", 0 )
	ROM_LOAD( "x2p-05mp_hack01.3h", 0x0000000, 0x800000, CRC(08e6a6f4) SHA1(b18bb531fade80a6639cd6202c6e490f8a3144bd) )
...
ROM_START( sfexphack01 )
	...
	ROM_REGION32_LE( 0x2400000, "bankedroms", 0 )
	ROM_LOAD( "sfp-05m_hack01.3h", 0x0000000, 0x400000, CRC(449cf487) SHA1(1bad501d328169e04dab371b669e2952541db408) )
