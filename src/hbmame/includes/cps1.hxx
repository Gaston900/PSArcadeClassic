...
//	optional_memory_bank m_okibank;
	...
	void varthb_layer_w(offs_t offset, u16 data);
	void varthb_layer2_w(u16 data);
	void wofr1bl_layer_w(offs_t offset, u16 data);
	void wofr1bl_layer2_w(u16 data);
	void wofr1bl_spr_base_w(u16 data);
...
//	void wofpic_layer_w(offs_t offset, u16 data);
//	void wofpic_layer2_w(u16 data);
	void captcommb2_layer_w(offs_t offset, u16 data);
	void captcommb2_soundlatch_w(offs_t offset, u16 data, u16 mem_mask = ~0);
	u8 captcommb2_soundlatch_r();
	void captcommb2_snd_bankswitch_w(u8 data);
	...
	void mtwinsb_layer_w(offs_t offset, u16 data);
	...
	void slampic_layer2_w(offs_t offset, u16 data, u16 mem_mask = ~0);
	...
	u16 slampic2_cps_a_r(offs_t offset);
	void slampic2_map(address_map &map);
	void slampic2_sound_w(u16 data);
	void slampic2_sound2_w(u16 data);
...
// HBMAME start
	...
	void captcommb2hb(machine_config &config);
	...
	void captcommb2hb_map(address_map &map);
	...
	void init_sk2h35();
	void init_wofb();
	DECLARE_MACHINE_START(captcommb2hb);
