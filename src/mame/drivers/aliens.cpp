...
ROM_START( aliensu2 )
	ROM_REGION( 0x30000, "maincpu", 0 ) /* code + banked roms */
	ROM_LOAD( "875_h01.c24", 0x00000, 0x20000, CRC(ba7f5489) SHA1(19b94d38917d15605d1d796a74129d140fd99cc4) )
	ROM_LOAD( "875_h02.e24", 0x20000, 0x10000, CRC(328ddb15) SHA1(4d8eefcbeeac7f4e864c5dc816b097f9ab27128d) )
...
GAME( 1990, aliensu,  aliens, aliens, aliens, aliens_state, empty_init, ROT0, "Konami", "Aliens (US set 1)",    MACHINE_SUPPORTS_SAVE )
GAME( 1990, aliensu2, aliens, aliens, aliens, aliens_state, empty_init, ROT0, "Konami", "Aliens (US set 2)",    MACHINE_SUPPORTS_SAVE )
