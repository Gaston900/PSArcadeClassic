...
void atetris_bartop_state::atetrisbp_map(address_map &map)
{
	...
	map(0x4000, 0x7fff).r(FUNC(atetris_mcu_state::slapstic_r));
	map(0x8000, 0xffff).rom();
}*/
...
//GAME( 1988, atetrisb5, atetris, atetrisb5, atetris,  atetris_state,     init_atetris, ROT0,   "bootleg",     "Tetris (bootleg set 5)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )																																													 
