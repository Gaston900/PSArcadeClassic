...
#define SFIII3_990512_FLASH \
	ROM_REGION( 0x200000, "simm1.0", 0 ) \
	ROM_LOAD( "sfiii3-simm1.0", 0x00000, 0x200000, CRC(66e66235) SHA1(0a98038721d176458d4f85dbd76c5edb93a65322) ) \
	ROM_REGION( 0x200000, "simm1.1", 0 ) \
	ROM_LOAD( "sfiii3-simm1.1", 0x00000, 0x200000, CRC(186e8c5f) SHA1(a63040201a660b56217a8cbab32f5c2c466ee5dd) ) \
	ROM_REGION( 0x200000, "simm1.2", 0 ) \
	ROM_LOAD( "sfiii3-simm1.2", 0x00000, 0x200000, CRC(bce18cab) SHA1(a5c28063d98c22403756fc926a20631456fb7dcc) ) \
	ROM_REGION( 0x200000, "simm1.3", 0 ) \
	ROM_LOAD( "sfiii3-simm1.3", 0x00000, 0x200000, CRC(129dc2c9) SHA1(c1e634d94b1c8f7f02a47703622de5cab3d0da3f) ) \
	ROM_REGION( 0x200000, "simm2.0", 0 ) \
	ROM_LOAD( "sfiii3-simm2.0",  0x00000, 0x200000, CRC(06eb969e) SHA1(d89f6a6585b76692d57d337f0f8186398fb056da) ) \
	ROM_REGION( 0x200000, "simm2.1", 0 ) \
	ROM_LOAD( "sfiii3-simm2.1",  0x00000, 0x200000, CRC(e7039f82) SHA1(8e81e66b5a4f45ae14b070a491bde47a6a74499f) ) \
...
#define JOJO_981202_FLASH \
	ROM_REGION( 0x200000, "simm1.0", 0 ) \
	ROM_LOAD( "jojo-simm1.0", 0x00000, 0x200000, CRC(e06ba886) SHA1(4defd5e8e1e6d0c439fed8a6454e89a59e24ea4c) ) \
	ROM_REGION( 0x200000, "simm1.1", 0 ) \
	ROM_LOAD( "jojo-simm1.1", 0x00000, 0x200000, CRC(6dd177c8) SHA1(c39db980f6fcca9c221e9be6f777eaf38f1b136b) ) \
	ROM_REGION( 0x200000, "simm1.2", 0 ) \
	ROM_LOAD( "jojo-simm1.2", 0x00000, 0x200000, CRC(d35a15e0) SHA1(576b92a94505764a10b9bcf82c02335e7ef62014) ) \
	ROM_REGION( 0x200000, "simm1.3", 0 ) \
	ROM_LOAD( "jojo-simm1.3", 0x00000, 0x200000, CRC(66d865ac) SHA1(5248c3f124af62b4a672d954ef15f86629feeacb) ) \
	ROM_REGION( 0x200000, "simm2.0", 0 ) \
	ROM_LOAD( "jojo-simm2.0", 0x00000, 0x200000, CRC(417e5dc1) SHA1(54ee9596c1c51811f3bdef7dbe77b44b34f230ca) ) \
	ROM_REGION( 0x200000, "simm2.1", 0 ) \
	ROM_LOAD( "jojo-simm2.1", 0x00000, 0x200000, CRC(c891c887) SHA1(42e84f774ee655e9a39b016a3cfe94262ed2e9f1) ) \
	ROM_REGION( 0x200000, "simm2.2", 0 ) \
	ROM_LOAD( "jojo-simm2.2", 0x00000, 0x200000, CRC(1e101f30) SHA1(56518c1646bb9452334856bb8bcc58892f9f93b9) ) \
	ROM_REGION( 0x200000, "simm2.3", 0 ) \
	ROM_LOAD( "jojo-simm2.3", 0x00000, 0x200000, CRC(1fd1d3e4) SHA1(bed2b77d58f1fdf7ba5ca7126d3db1dd0f8c80b4) ) \
	ROM_REGION( 0x200000, "simm3.0", 0 ) \
	ROM_LOAD( "jojo-simm3.0",  0x00000, 0x200000, CRC(de7fc9c1) SHA1(662b85a990b04c855773506c936317e62fab4a05) ) \
	ROM_REGION( 0x200000, "simm3.1", 0 ) \
	ROM_LOAD( "jojo-simm3.1",  0x00000, 0x200000, CRC(43d053d3) SHA1(54ff0e9c164e0d1649522c330ccc7e5d79e0bc85) ) \
...
#define JOJOBA_991015_FLASH \
	ROM_REGION( 0x200000, "simm1.0", 0 ) \
	ROM_LOAD( "jojoba-simm1.0", 0x00000, 0x200000, CRC(b3cc516d) SHA1(cac67a5bf9d01af226be377e2b1b8ed4ea7fd164) ) \
	ROM_REGION( 0x200000, "simm1.1", 0 ) \
	ROM_LOAD( "jojoba-simm1.1", 0x00000, 0x200000, CRC(dab4bdc7) SHA1(47283071de152a0b2b96d3f3fc22537677c35d3f) ) \
	ROM_REGION( 0x200000, "simm1.2", 0 ) \
	ROM_LOAD( "jojoba-simm1.2", 0x00000, 0x200000, CRC(a6a4bf48) SHA1(1684663252894538de4855eee336ffc031142ba9) ) \
	ROM_REGION( 0x200000, "simm1.3", 0 ) \
	ROM_LOAD( "jojoba-simm1.3", 0x00000, 0x200000, CRC(731229ee) SHA1(2171ffa115752b0dcc1695f4a5d0557237a73db8) ) \
	ROM_REGION( 0x200000, "simm2.0", 0 ) \
...
/*****************************************************************************************
 ...
 HISPANIC = ROM_FILL(0X1FECB,1,0X64)
 BRAZIL = ROM_FILL(0X1FECB,1,0X67)
 OCEANIA  = ROM_FILL(0X1FECB,1,0X66)

 Street Fighter III 2nd Impact: Giant Attack
 EURO = ROM_FILL(0X1FECB,1,0XAB)
 BRAZIL = ROM_FILL(0X1FECB,1,0XAF)

 Street Fighter III: New Generation
 BRAZIL = ROM_FILL(0X1FECB,1,0XB3)
 OCEANIA = ROM_FILL(0X1FECB,1,0XB2)

 JoJo's Bizarre Adventure
 ASIA = ROM_FILL(0X1FECB,1,0X28)
 BRAZIL = ROM_FILL(0X1FECB,1,0X2C) 
 HISPANIC = ROM_FILL(0X1FECB,1,0X2F) 
 KOREA = ROM_FILL(0X1FECB,1,0X22) 
 OCEANIA = ROM_FILL(0X1FECB,1,0X2D) 
 USA = ROM_FILL(0X1FECB,1,0X2E) 

 JoJo's Venture
 BRAZIL = ROM_FILL(0X1FECB,1,0X0B)
 HISPANIC = ROM_FILL(0X1FECB,1,0X08)
 OCEANIA = ROM_FILL(0X1FECB,1,0X0A)
...
ROM_START( jojobar1 )
    ...
    ROM_FILL(0X1FECC,1,0X6A)
    ROM_FILL(0X1FECB,1,0XB9)
