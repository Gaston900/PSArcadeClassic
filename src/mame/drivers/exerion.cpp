...
ROM_START( exerionb2 )
	...
	ROM_REGION( 0x02000, "gfx1", 0 ) // slight differences compared to the original
	ROM_LOAD( "e6.bin",  0x00000, 0x2000, CRC(24a2ceb5) SHA1(77fa649e75fe549091cf401307c583e9b6acfdce) )

	ROM_REGION( 0x04000, "gfx2", 0 ) // same as the original
	...
	ROM_REGION( 0x08000, "gfx3", ROMREGION_ERASE00 ) // smaller ROMs, but same contents but for 3.bin
	...
	ROM_REGION( 0x0420, "proms", 0 ) // not dumped for this set
	...
	ROM_LOAD( "exerion.k4",   0x0320, 0x0100, BAD_DUMP CRC(ffc2ba43) SHA1(03be1c41d6ac3fc11439caef04ef5ffa60d6aec4) )
ROM_END
...
ROM_START( exerionba )
	...
	ROM_LOAD( "82s129.3", 0x0320, 0x0100, CRC(ffc2ba43) SHA1(03be1c41d6ac3fc11439caef04ef5ffa60d6aec4) )
ROM_END
