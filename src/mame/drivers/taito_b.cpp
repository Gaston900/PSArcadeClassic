...
ROM_START( bublbust ) // Purportedly a location test version, but has the same version number and build date as the released Japanese set below
	...
	ROM_REGION( 0x100000, "ymsnd", 0 ) // located on Taito C0503002A ROM PCB - Half the size of the Japanese ADPCMA sample ROM
...
GAME( 1993, ryujin,   0,       selfeena, ryujin,    taitob_state, init_taito_b, ROT270, "Taito Corporation", "Ryu Jin (Japan, ET910000A PCB)", MACHINE_SUPPORTS_SAVE )
