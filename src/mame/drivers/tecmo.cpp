...
ROM_START( rygarb )
	ROM_REGION( 0x20000, "maincpu", 0 )
	ROM_LOAD( "5b.5p",        0x00000, 0x08000, CRC(0e13e0e4) SHA1(e4eed9e4f424838cd80303554d98048b42a197ef) )
...
GAME( 1986, rygarb,    rygar,    rygar,     rygar,     tecmo_state, init_rygar,    ROT0,  "Tecmo",   "Rygar (US, bootleg)",          MACHINE_SUPPORTS_SAVE )
