...
extern uint32_t RGBtoYUV[65536];

inline uint16_t interp_32_to_15(uint32_t src)
{
	return (uint16_t)
...
inline uint32_t interp_15_to_32(uint16_t src)
{
...
inline uint16_t interp_32_to_16(uint32_t src)
{
	return (uint16_t)
...
inline uint32_t interp_16_to_32(uint16_t src)
{
	uint8_t r = (src & INTERP_MASK_16_R) >> 11;
	uint8_t g = (src & INTERP_MASK_16_G) >> 5;
	uint8_t b = (src & INTERP_MASK_16_B);
...
inline int interp_diff(uint16_t c1, uint16_t c2)
{
...
inline uint16_t interp_15_##a##b(uint16_t p1, uint16_t p2) \
{ \
...
inline uint16_t interp_15_##a##b##c(uint16_t p1, uint16_t p2, uint16_t p3) \
{ \
...
inline uint16_t interp_16_##a##b(uint16_t p1, uint16_t p2) \
{ \
...
inline uint16_t interp_16_##a##b##c(uint16_t p1, uint16_t p2, uint16_t p3) \
{ \
...
inline uint32_t interp_32_##a##b(uint32_t p1, uint32_t p2) \
{ \
...
inline uint32_t interp_32_##a##b##c(uint32_t p1, uint32_t p2, uint32_t p3) \
{ \
...
inline uint16_t interp_15_11(uint16_t p1, uint16_t p2)
{
...
inline uint16_t interp_15_211(uint16_t p1, uint16_t p2, uint16_t p3)
{
...
inline uint16_t interp_15_31(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_2
...
inline uint16_t interp_15_521(uint16_t p1, uint16_t p2, uint16_t p3)
{
...
inline uint16_t interp_15_431(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_15_53(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_15_332(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
#else
	uint16_t t = interp_15_11(p1, p2);
	return interp_15_11(t, interp_15_11(p3, t));
#endif
}

inline uint16_t interp_15_611(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_15_71(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_3
...
#if 0
inline uint16_t interp_15_772(uint16_t p1, uint16_t p2, uint16_t p3)
{
...
inline uint16_t interp_15_1411(uint16_t p1, uint16_t p2, uint16_t p3)
{
...
inline uint16_t interp_15_151(uint16_t p1, uint16_t p2)
{
...
inline uint16_t interp_15_97(uint16_t p1, uint16_t p2)
{
...
inline uint16_t interp_16_11(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_1
...
inline uint16_t interp_16_211(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_2
...
inline uint16_t interp_16_31(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_2
...
inline uint16_t interp_16_521(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_16_431(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_16_53(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_16_332(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
#else
	uint16_t t = interp_16_11(p1, p2);
	return interp_16_11(t, interp_16_11(p3, t));
#endif
}

inline uint16_t interp_16_611(uint16_t p1, uint16_t p2, uint16_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint16_t interp_16_71(uint16_t p1, uint16_t p2)
{
#ifdef USE_INTERP_MASK_3
...
inline uint32_t interp_32_11(uint32_t p1, uint32_t p2)
{
#ifdef USE_INTERP_MASK_1
...
inline uint32_t interp_32_211(uint32_t p1, uint32_t p2, uint32_t p3)
{
#ifdef USE_INTERP_MASK_2
...
inline uint32_t interp_32_31(uint32_t p1, uint32_t p2)
{
#ifdef USE_INTERP_MASK_2
...
inline uint32_t interp_32_521(uint32_t p1, uint32_t p2, uint32_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint32_t interp_32_431(uint32_t p1, uint32_t p2, uint32_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint32_t interp_32_53(uint32_t p1, uint32_t p2)
{
#ifdef USE_INTERP_MASK_3
...
inline uint32_t interp_32_332(uint32_t p1, uint32_t p2, uint32_t p3)
{
#ifdef USE_INTERP_MASK_3
...
#else
	uint32_t t = interp_32_11(p1, p2);
	return interp_32_11(t, interp_32_11(p3, t));
#endif
}

inline uint32_t interp_32_611(uint32_t p1, uint32_t p2, uint32_t p3)
{
#ifdef USE_INTERP_MASK_3
...
inline uint32_t interp_32_71(uint32_t p1, uint32_t p2)
{
#ifdef USE_INTERP_MASK_3
...
inline int interp_15_diff(uint16_t p1, uint16_t p2)
{
	int r, g, b;
	int y, u, v;
...
inline int interp_16_diff(uint16_t p1, uint16_t p2)
{
	int r, g, b;
	int y, u, v;
...
inline int interp_32_diff(uint32_t p1, uint32_t p2)
{
	int r, g, b;
	int y, u, v;
